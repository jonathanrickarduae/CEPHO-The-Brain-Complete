...
export const EXTERNAL_SME_RESOURCES: ExternalSMEResource[] = [
  // Consulting Firms
  {
    ...
    category: "consulting",
    description:
      "Global management consulting with deep industry expertise and proprietary research.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/McKinsey_and_Company_Logo_1.svg/1200px-McKinsey_and_Company_Logo_1.svg.png",
    portalUrl:
  ...
  },
  {
    ...
    category: "consulting",
    description:
      "Strategic advisory with expertise in innovation, growth, and digital transformation.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Boston_Consulting_Group_2020_logo.svg/1200px-Boston_Consulting_Group_2020_logo.svg.png",
  ...
  },
  {
    ...
    category: "consulting",
    description:
      "Results-focused consulting with expertise in private equity and customer strategy.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Bain_and_Company_Logo_1.svg/1200px-Bain_and_Company_Logo_1.svg.png",
  ...
  },
  {
    ...
    category: "consulting",
    description:
      "Professional services network with audit, tax, and advisory capabilities.",
    logoUrl:
  ...
  },
  {
    ...
    category: "consulting",
    description:
      "Largest professional services network with comprehensive business advisory.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Deloitte.svg/1200px-Deloitte.svg.png",
    portalUrl:
      "https://www2.deloitte.com/global/en/services/consulting-deloitte.html",
    hasApi: false,
    apiStatus: "none",
    specializations: [
      "Audit",
  ...
  // Research & Media
  {
    ...
    category: "media",
    description:
      "Global news and analysis with deep economic and political intelligence.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/The_Economist_Logo.svg/1200px-The_Economist_Logo.svg.png",
  ...
  },
  {
    ...
    category: "media",
    description:
      "Premier business and financial news with market intelligence and analysis.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Financial_Times_corporate_logo_%28no_background%29.svg/1200px-Financial_Times_corporate_logo_%28no_background%29.svg.png",
  ...
  },
  {
    ...
    category: "media",
    description:
      "Financial data, analytics, and news platform for professionals.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/New_Bloomberg_Logo.svg/1200px-New_Bloomberg_Logo.svg.png",
  ...
  },
  {
    ...
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Harvard_Business_Review_Logo.svg/1200px-Harvard_Business_Review_Logo.svg.png",
  ...
  // AI Platforms
  {
    ...
    description:
      "Create AI clones of experts and thought leaders for scalable knowledge sharing.",
  ...
  },
  {
    ...
    category: "ai_platform",
    description:
      "AI-powered research assistant with real-time web search and citations.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/1/1d/Perplexity_AI_logo.png",
  ...
  },
  {
    ...
    category: "ai_platform",
    description:
      "Leading AI models for text, code, and multimodal applications.",
    logoUrl:
  ...
  // Data & Research Platforms
  {
    ...
    category: "data",
    description:
      "Statistics, market data, and industry reports from 22,500+ sources.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Statista_Logo.svg/1200px-Statista_Logo.svg.png",
  ...
  },
  {
    ...
    category: "research",
    description:
      "Technology research and advisory for enterprise decision-making.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Gartner_logo.svg/1200px-Gartner_logo.svg.png",
  ...
  },
  {
    ...
    category: "research",
    description:
      "Customer-obsessed research and advisory for business and technology.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Forrester_Research_logo.svg/1200px-Forrester_Research_logo.svg.png",
  ...
  },
  {
    ...
    category: "data",
    description:
      "Market intelligence on emerging technology and venture capital.",
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/CB_Insights_logo.svg/1200px-CB_Insights_logo.svg.png",
  ...
  },
  {
    ...
    category: "training",
    description:
      "University courses and professional certificates from top institutions.",
    logoUrl:
  ...
  },
  {
    ...
    logoUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/MasterClass_logo.svg/1200px-MasterClass_logo.svg.png",
