...
export const PLATFORM_INTELLIGENCE: PlatformIntelligence[] = [
  {
    ...
    color: "#E4405F",
    audienceProfile:
      "Visual-first users aged 18-44, lifestyle and brand discovery",
    primaryGoal:
      "Build brand awareness and community through visual storytelling",
    algorithmName: "Instagram Ranking System",
    algorithmSummary:
      "Instagram uses machine learning to predict what content you'll find most valuable. It ranks content based on relationship signals, interest signals, and timeliness. Each surface (Feed, Stories, Reels, Explore) has its own ranking algorithm.",
    keySignals: [
      {
        name: "Relationship",
        weight: "critical",
        description:
          "How close you are to the person - do you message, comment, tag each other?",
        optimization:
          "Encourage DMs, reply to every comment within 1 hour, tag collaborators",
      },
      {
        name: "Interest",
        weight: "critical",
        description:
          "Does the user typically engage with this type of content?",
        optimization:
          "Stay consistent with content pillars, use relevant hashtags",
      },
      {
        name: "Timeliness",
        weight: "high",
        ...
        optimization:
          "Post when your audience is most active, use Stories for real-time",
      },
      {
        name: "Session Time",
        weight: "high",
        ...
        optimization:
          "Create carousel posts (average 1.4x more reach), use engaging hooks",
      },
      {
        name: "Saves",
        weight: "critical",
        ...
        optimization:
          "Create educational content, tips, tutorials, reference guides",
      },
      {
        name: "Shares",
        weight: "critical",
        ...
        optimization:
          "Create relatable, shareable content - memes, quotes, insights",
      },
    ],
    contentFormats: [
      {
    ...
    metrics: [
      {
        name: "Reach",
        target: "10-20% of followers per post",
        importance: "Primary growth indicator",
      },
      {
        name: "Engagement Rate",
        target: "3-6% (good), 6%+ (excellent)",
        importance: "Content quality signal",
      },
      {
        name: "Saves",
        target: "2-5% of reach",
        importance: "Algorithm ranking signal",
      },
      {
        name: "Shares",
        target: "1-3% of reach",
      ...
      {
        name: "Profile Visits",
        target: "Track weekly growth",
        importance: "Conversion funnel metric",
      },
    ],
  },
  {
    ...
    color: "#FF0000",
    audienceProfile:
      "Intent-driven viewers seeking education, entertainment, or solutions",
    primaryGoal:
      "Build authority and long-term discoverability through searchable video content",
    algorithmName: "YouTube Recommendation System",
    algorithmSummary:
      "YouTube's algorithm optimizes for viewer satisfaction, not just clicks. It uses deep neural networks to predict which videos will keep viewers on the platform longest. Watch time, click-through rate, and viewer satisfaction surveys drive recommendations.",
    keySignals: [
      {
        name: "Watch Time",
        weight: "critical",
        ...
        optimization:
          "Create longer content (8-15 min sweet spot), strong hooks, pattern interrupts",
      },
      {
        ...
        optimization:
          "A/B test thumbnails, use curiosity gaps in titles, faces with emotion",
      },
      {
      ...
      },
      {
        ...
        optimization:
          "End screens, playlists, series content, suggested video mentions",
      },
      {
        name: "Engagement",
        weight: "high",
        ...
        optimization:
          "Ask for engagement verbally, reply to comments, create discussion",
      },
      {
    ...
    metrics: [
      {
        ...
        importance: "Thumbnail/title effectiveness",
      },
      {
      ...
      {
        name: "Watch Time",
        target: "4,000 hours for monetization",
        importance: "Primary ranking factor",
      },
      {
        name: "Subscriber Conversion",
        target: "2-5% of viewers",
        importance: "Channel growth indicator",
      },
      {
        name: "Impressions",
        target: "Track weekly growth",
        importance: "Algorithm reach indicator",
      },
    ],
  },
  {
    ...
    color: "#000000",
    audienceProfile:
      "Gen Z and Millennials seeking entertainment, trends, and authentic content",
    primaryGoal:
      "Rapid brand awareness and viral reach through trend participation",
    algorithmName: "For You Page (FYP) Algorithm",
    algorithmSummary:
      "TikTok's algorithm is the most democratic - follower count matters less than content quality. It tests every video with small audiences and scales based on performance. Completion rate and rewatches are the strongest signals.",
    keySignals: [
      {
        ...
        optimization:
          "Keep videos short (7-15 sec for beginners), strong hooks, no fluff",
      },
      {
        name: "Rewatch Rate",
        weight: "critical",
        ...
        optimization:
          "Create loop-worthy content, surprise endings, hidden details",
      },
      {
        name: "Shares",
        weight: "critical",
      ...
      },
      {
        ...
        optimization:
          "Ask questions, create debate, respond to comments with videos",
      },
      {
        name: "Profile Visits",
        weight: "high",
        ...
        optimization:
          "Tease series content, create curiosity about who you are",
      },
      {
    ...
    metrics: [
      {
        name: "Completion Rate",
        target: "80%+ for short videos",
        importance: "Primary FYP signal",
      },
      {
        name: "Shares",
        target: "1%+ of views",
      ...
      },
      {
        name: "Comments",
        target: "0.5%+ of views",
        importance: "Engagement quality signal",
      },
      {
        name: "Follower Growth",
        target: "Track daily during growth",
        importance: "Account momentum",
      },
      {
        name: "Video Views",
        target: "Baseline vs viral tracking",
        importance: "Content performance",
      },
    ],
  },
  {
    ...
    color: "#0A66C2",
    audienceProfile:
      "Professionals, B2B decision-makers, job seekers, thought leaders",
    primaryGoal:
      "Build professional authority and generate B2B leads through thought leadership",
    algorithmName: "LinkedIn Feed Algorithm",
    algorithmSummary:
      "LinkedIn prioritizes content that sparks professional conversations. It uses a multi-stage ranking system: spam filter → quality scoring → engagement prediction → network boost. Dwell time and meaningful comments are heavily weighted.",
    keySignals: [
      {
        name: "Dwell Time",
        weight: "critical",
        ...
        optimization:
          "Write longer posts (1,200-1,500 chars), use line breaks, tell stories",
      },
      {
        ...
        optimization:
          "Post when network is active, engage immediately with comments",
      },
      {
        ...
        optimization:
          "Ask questions, create discussion, reply to every comment",
      },
      {
      ...
      },
      {
        ...
        optimization:
          "Use document posts, native video, text posts over link posts",
      },
      {
        name: "Creator Mode",
        weight: "medium",
    ...
    metrics: [
      {
        name: "Impressions",
        target: "2-5x your follower count",
        importance: "Reach indicator",
      },
      {
        name: "Engagement Rate",
        target: "2-5% (good), 5%+ (excellent)",
        importance: "Content quality signal",
      },
      {
        name: "Profile Views",
        target: "Track weekly growth",
        importance: "Personal brand indicator",
      },
      {
        name: "Connection Growth",
        target: "50-100/week during growth",
        importance: "Network expansion",
      },
      {
        name: "SSI Score",
        target: "70+ (industry leader)",
        importance: "LinkedIn's own metric",
      },
    ],
  },
];
...
export const POSTING_FREQUENCY = {
  instagram: {
    ...
    max: 7,
    unit: "posts per week",
    notes: "Plus daily Stories",
  },
  youtube: {
    min: 1,
    optimal: 2,
    max: 3,
    unit: "videos per week",
    notes: "Consistency > frequency",
  },
  tiktok: {
    min: 7,
    optimal: 14,
    max: 21,
    unit: "posts per week",
    notes: "1-3 per day during growth",
  },
  linkedin: {
    min: 3,
    optimal: 5,
...
export function getOptimalPostingTimes(
  ...
  if (!platform) return [];
  if (day) {
    return platform.optimalPostingTimes.filter(
...
export function getContentRecommendations(
  ...
  switch (goal) {
    ...
    case "conversion":
      return platform.contentFormats.filter(
        f =>
          f.type.toLowerCase().includes("video") ||
          f.type.toLowerCase().includes("carousel")
      );
    case "authority":
      return platform.contentFormats.filter(
        f =>
          f.optimalLength.includes("minute") ||
