...
export const valueChainPhases: ValueChainPhase[] = [
  {
    ...
    shortName: "Ideate",
    description:
      "Generate and capture initial business ideas, concepts, and opportunities",
    objectives: [
  ...
  },
  {
    ...
    shortName: "Innovate",
    description:
      "Develop and refine the concept into a viable business proposition",
    objectives: [
  ...
  },
  {
    ...
    shortName: "Develop",
    description:
      "Build the product/service and establish operational foundations",
    objectives: [
...
export function calculatePhaseProgress(
  ...
  const completed = phase.qualityGateChecks.filter(check =>
  ...
  if (inProgressPhase) {
    ...
    if (phase) {
      const phaseProgress = calculatePhaseProgress(
        inProgressPhase.completedChecks,
        phase
      );
