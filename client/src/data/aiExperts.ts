...
const investmentExperts: AIExpert[] = [
  {
    ...
    avatar: '👨‍💼',
    avatarUrl: '/avatars/victor-sterling.png',
  ...
  },
  {
    ...
    name: 'Marcus Macro',
    avatar: '📊',
    avatarUrl: '/avatars/marcus-macro.png',
  ...
  },
  {
    ...
    name: 'Aurora Disrupt',
    avatar: '🚀',
    avatarUrl: '/avatars/aurora-disrupt.png',
  ...
  },
  {
    ...
    name: 'Maria Venture',
    avatar: '🦄',
    avatarUrl: '/avatars/sophia-venture.png',
...
const entrepreneurshipExperts: AIExpert[] = [
  ...
  },
  {
    ...
    name: 'Elon Future',
    avatar: '🚀',
    avatarUrl: '/avatars/elon-tech.png',
  ...
  { id: 'ent-009', name: 'Indra Operations', avatar: '⚙️', avatarUrl: '/avatars/indra-operations.png', specialty: 'Operational Excellence', category: 'Entrepreneurship & Strategy', compositeOf: ['Indra Nooyi', 'Tim Cook', 'Mary Barra'], bio: 'Expert in operational excellence, supply chain, and execution.', strengths: ['Operations', 'Efficiency', 'Execution', 'Supply chain'], weaknesses: ['May lack vision', 'Incremental thinking'], thinkingStyle: 'Operational, efficient, execution-focused', performanceScore: 93, projectsCompleted: 51, insightsGenerated: 278, lastUsed: '2024-01-10', status: 'active' },
...
const healthcareExperts: AIExpert[] = [
  ...
  { id: 'hc-011', name: 'Dr. Jennifer Walsh', avatar: '✅', specialty: 'Pharmaceutical Quality, GMP & Manufacturing', category: 'Healthcare & Biotech', compositeOf: ['QA directors', 'GMP inspectors', 'CMC leaders', 'Process development experts'], bio: 'Expert in pharmaceutical quality systems, GMP compliance, CMC development, and manufacturing. Covers quality assurance through to commercial scale-up.', strengths: ['Quality systems', 'GMP compliance', 'Process development', 'Scale-up', 'Tech transfer'], weaknesses: ['Resource intensive', 'Capital requirements'], thinkingStyle: 'Quality-obsessed, engineering-minded, systematic', performanceScore: 89, projectsCompleted: 46, insightsGenerated: 256, lastUsed: '2024-01-09', status: 'active', preferredBackend: 'claude', backendRationale: 'Quality compliance requires precise, detailed guidance' },

  // === DIAGNOSTICS & PRECISION MEDICINE (Combined) ===
  { id: 'hc-012', name: 'Dr. Alexandra Foster', avatar: '🧬', specialty: 'Diagnostics, Genomics & Precision Medicine', category: 'Healthcare & Biotech', compositeOf: ['Dx company leaders', 'CDx development experts', 'Genomics pioneers', 'Pharmacogenomics experts'], bio: 'Expert in diagnostic development, companion diagnostics, genomics, and precision medicine. Specialist in biomarker-driven patient selection and personalized medicine implementation.', strengths: ['CDx development', 'Genomic analysis', 'Biomarker strategy', 'Pharmacogenomics', 'Precision medicine'], weaknesses: ['Co-development complexity', 'Data interpretation challenges'], thinkingStyle: 'Precision-focused, data-driven, clinically translational', performanceScore: 88, projectsCompleted: 37, insightsGenerated: 212, lastUsed: '2024-01-08', status: 'active', preferredBackend: 'claude', backendRationale: 'Precision medicine requires sophisticated scientific reasoning' },

  // === MEDICAL AFFAIRS ===
  { id: 'hc-013', name: 'Dr. Michael Thornbury', avatar: '👨‍⚕️', specialty: 'Medical Affairs & Scientific Communication', category: 'Healthcare & Biotech', compositeOf: ['Medical directors', 'MSL team leaders', 'Publication planning experts'], bio: 'Expert in medical affairs strategy, KOL engagement, and scientific communication. Bridges clinical development and commercial with evidence-based medical strategy.', strengths: ['Medical strategy', 'KOL engagement', 'Publication planning', 'Advisory boards'], weaknesses: ['Commercial-medical tension', 'Compliance constraints'], thinkingStyle: 'Scientifically credible, relationship-focused, strategically aligned', performanceScore: 88, projectsCompleted: 43, insightsGenerated: 234, lastUsed: '2024-01-09', status: 'active', preferredBackend: 'claude', backendRationale: 'Medical communication requires nuanced scientific messaging' },
