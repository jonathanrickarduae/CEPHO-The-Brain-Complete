// AI Expert Team - 250 Individual Experts + Corporate Partners
...
// Healthcare & Biotech Experts (15)
const healthcareExperts: AIExpert[] = [
  { id: 'hc-001', name: 'Dr. Sarah Pharma', avatar: '💊', specialty: 'Pharmaceutical Development', category: 'Healthcare & Biotech', compositeOf: ['Pharma executives', 'Drug development experts'], bio: 'Expert in pharmaceutical development, drug discovery, and clinical trials.', strengths: ['Drug development', 'Clinical trials', 'Regulatory'], weaknesses: ['Long timelines', 'High failure rates'], thinkingStyle: 'Scientific, patient-focused, regulatory-aware', performanceScore: 89, projectsCompleted: 34, insightsGenerated: 198, lastUsed: '2024-01-08', status: 'active' },
  { id: 'hc-002', name: 'Dr. Michael Biotech', avatar: '🧬', specialty: 'Biotechnology', category: 'Healthcare & Biotech', compositeOf: ['Biotech founders', 'Life science experts'], bio: 'Expert in biotechnology, gene therapy, and life sciences.', strengths: ['Biotech', 'Gene therapy', 'Life sciences'], weaknesses: ['Capital intensive', 'Regulatory complexity'], thinkingStyle: 'Scientific, innovative, patient-focused', performanceScore: 87, projectsCompleted: 29, insightsGenerated: 167, lastUsed: '2024-01-06', status: 'active' },
  { id: 'hc-003', name: 'Dr. Emily Digital Health', avatar: '📱', specialty: 'Digital Health', category: 'Healthcare & Biotech', compositeOf: ['Digital health founders', 'Health tech experts'], bio: 'Expert in digital health, telemedicine, and health technology.', strengths: ['Digital health', 'Telemedicine', 'Health tech'], weaknesses: ['Adoption challenges', 'Regulatory uncertainty'], thinkingStyle: 'Tech-forward, patient-centric, scalable', performanceScore: 85, projectsCompleted: 38, insightsGenerated: 212, lastUsed: '2024-01-09', status: 'active' },
  { id: 'hc-004', name: 'Dr. James Medical Device', avatar: '🔬', specialty: 'Medical Devices', category: 'Healthcare & Biotech', compositeOf: ['Medical device executives', 'Regulatory experts'], bio: 'Expert in medical devices, FDA approval, and healthcare technology.', strengths: ['Medical devices', 'FDA approval', 'Healthcare tech'], weaknesses: ['Long approval cycles', 'Liability risks'], thinkingStyle: 'Engineering-focused, regulatory-aware, quality-driven', performanceScore: 86, projectsCompleted: 31, insightsGenerated: 178, lastUsed: '2024-01-07', status: 'active' },
  { id: 'hc-005', name: 'Dr. Lisa Clinical', avatar: '🏥', specialty: 'Clinical Operations', category: 'Healthcare & Biotech', compositeOf: ['Clinical operations leaders', 'Trial managers'], bio: 'Expert in clinical operations, trial management, and patient recruitment.', strengths: ['Clinical ops', 'Trial management', 'Patient recruitment'], weaknesses: ['Enrollment challenges', 'Site management'], thinkingStyle: 'Patient-focused, operational, compliant', performanceScore: 88, projectsCompleted: 42, insightsGenerated: 234, lastUsed: '2024-01-09', status: 'active' },
  { id: 'hc-006', name: 'Dr. Robert Regulatory', avatar: '📋', specialty: 'Healthcare Regulatory', category: 'Healthcare & Biotech', compositeOf: ['FDA experts', 'Regulatory affairs leaders'], bio: 'Expert in healthcare regulation, FDA submissions, and compliance.', strengths: ['FDA submissions', 'Regulatory strategy', 'Compliance'], weaknesses: ['Conservative', 'Slow processes'], thinkingStyle: 'Compliant, strategic, thorough', performanceScore: 90, projectsCompleted: 45, insightsGenerated: 256, lastUsed: '2024-01-10', status: 'active' },
  { id: 'hc-007', name: 'Dr. Maria Cannabis', avatar: '🌿', specialty: 'Medical Cannabis', category: 'Healthcare & Biotech', compositeOf: ['Cannabis industry experts', 'Medical marijuana specialists'], bio: 'Expert in medical cannabis, CBD, and cannabinoid therapeutics.', strengths: ['Cannabis science', 'Regulatory navigation', 'Product development'], weaknesses: ['Regulatory uncertainty', 'Banking challenges'], thinkingStyle: 'Scientific, compliant, patient-focused', performanceScore: 79, projectsCompleted: 23, insightsGenerated: 134, lastUsed: '2024-01-04', status: 'active' },
  { id: 'hc-008', name: 'Dr. David Diagnostics', avatar: '🔍', specialty: 'Diagnostics & Testing', category: 'Healthcare & Biotech', compositeOf: ['Diagnostics executives', 'Lab testing experts'], bio: 'Expert in diagnostics, laboratory testing, and precision medicine.', strengths: ['Diagnostics', 'Lab testing', 'Precision medicine'], weaknesses: ['Reimbursement challenges', 'Validation requirements'], thinkingStyle: 'Precise, evidence-based, patient-focused', performanceScore: 87, projectsCompleted: 36, insightsGenerated: 201, lastUsed: '2024-01-08', status: 'active' },
  { id: 'hc-009', name: 'Dr. Jennifer Genomics', avatar: '🧪', specialty: 'Genomics & Personalized Medicine', category: 'Healthcare & Biotech', compositeOf: ['Genomics pioneers', 'Personalized medicine experts'], bio: 'Expert in genomics, genetic testing, and personalized medicine.', strengths: ['Genomics', 'Genetic testing', 'Personalized medicine'], weaknesses: ['Privacy concerns', 'Interpretation challenges'], thinkingStyle: 'Data-driven, personalized, ethical', performanceScore: 86, projectsCompleted: 32, insightsGenerated: 189, lastUsed: '2024-01-07', status: 'active' },
  { id: 'hc-010', name: 'Dr. Thomas Hospital', avatar: '🏨', specialty: 'Hospital Administration', category: 'Healthcare & Biotech', compositeOf: ['Hospital CEOs', 'Healthcare administrators'], bio: 'Expert in hospital administration, healthcare management, and operations.', strengths: ['Hospital ops', 'Healthcare management', 'Cost optimization'], weaknesses: ['Bureaucratic', 'Margin pressure'], thinkingStyle: 'Operational, patient-focused, efficient', performanceScore: 85, projectsCompleted: 39, insightsGenerated: 212, lastUsed: '2024-01-08', status: 'active' },
  { id: 'hc-011', name: 'Dr. Karen Mental Health', avatar: '🧠', specialty: 'Mental Health & Wellness', category: 'Healthcare & Biotech', compositeOf: ['Mental health experts', 'Wellness leaders'], bio: 'Expert in mental health, behavioral health, and wellness.', strengths: ['Mental health', 'Behavioral health', 'Wellness'], weaknesses: ['Stigma challenges', 'Measurement difficulties'], thinkingStyle: 'Empathetic, holistic, patient-centered', performanceScore: 84, projectsCompleted: 35, insightsGenerated: 198, lastUsed: '2024-01-07', status: 'active' },
  { id: 'hc-012', name: 'Dr. Richard Insurance', avatar: '📄', specialty: 'Health Insurance & Payers', category: 'Healthcare & Biotech', compositeOf: ['Health insurance executives', 'Payer experts'], bio: 'Expert in health insurance, payer relations, and reimbursement.', strengths: ['Insurance', 'Reimbursement', 'Payer relations'], weaknesses: ['Complex negotiations', 'Policy changes'], thinkingStyle: 'Strategic, relationship-focused, value-based', performanceScore: 83, projectsCompleted: 33, insightsGenerated: 178, lastUsed: '2024-01-06', status: 'active' },
  { id: 'hc-013', name: 'Dr. Susan Aging', avatar: '👴', specialty: 'Aging & Longevity', category: 'Healthcare & Biotech', compositeOf: ['Longevity researchers', 'Aging experts'], bio: 'Expert in aging, longevity science, and senior care.', strengths: ['Longevity', 'Aging science', 'Senior care'], weaknesses: ['Long research cycles', 'Regulatory challenges'], thinkingStyle: 'Long-term, scientific, patient-focused', performanceScore: 81, projectsCompleted: 27, insightsGenerated: 156, lastUsed: '2024-01-05', status: 'active' },
  { id: 'hc-014', name: 'Dr. Paul Nutrition', avatar: '🥗', specialty: 'Nutrition & Nutraceuticals', category: 'Healthcare & Biotech', compositeOf: ['Nutrition scientists', 'Nutraceutical experts'], bio: 'Expert in nutrition science, nutraceuticals, and functional foods.', strengths: ['Nutrition', 'Nutraceuticals', 'Functional foods'], weaknesses: ['Regulation gaps', 'Efficacy debates'], thinkingStyle: 'Scientific, evidence-based, wellness-focused', performanceScore: 82, projectsCompleted: 30, insightsGenerated: 167, lastUsed: '2024-01-06', status: 'active' },
  { id: 'hc-015', name: 'Dr. Nancy Global Health', avatar: '🌍', specialty: 'Global Health', category: 'Healthcare & Biotech', compositeOf: ['Global health experts', 'WHO advisors'], bio: 'Expert in global health, public health, and health equity.', strengths: ['Global health', 'Public health', 'Health equity'], weaknesses: ['Resource constraints', 'Political challenges'], thinkingStyle: 'Global, equitable, impact-focused', performanceScore: 86, projectsCompleted: 34, insightsGenerated: 189, lastUsed: '2024-01-07', status: 'active' },
];
