...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    documents: [
      { id: 'p5-1', name: 'Initial Proposal.pdf', type: 'document', size: '1.8 MB', date: '2024-01-07', status: 'draft' },
      { id: 'p5-2', name: 'Market Research.xlsx', type: 'data', size: '2.4 MB', date: '2024-01-06', status: 'working' },
      { id: 'p5-3', name: 'Concept Mockups.png', type: 'image', size: '3.2 MB', date: '2024-01-05', source: 'AI Generated' },
    ],
  },
  {
    id: 'project-6',
