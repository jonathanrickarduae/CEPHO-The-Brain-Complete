...
export const sampleProjects: DemoProject[] = [
  {
    ...
    deliverables: [
      ...
      },
      {
        ...
        type: "presentation",
        status: "pending",
        assignedTo: "Strategy Consultant",
    ...
    deliverables: [
      {
        ...
        type: "financial",
        status: "approved",
        assignedTo: "Real Estate Analyst",
        dueDate: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000),
      },
      {
        id: "d8",
...
export const sampleTasks: DemoTask[] = [
  {
    ...
    description:
      "Check revenue growth rates and margin assumptions against industry benchmarks",
    priority: "high",
    status: "pending",
    dueDate: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000),
...
export const sampleConversations: DemoConversation[] = [
  ...
  },
  {
    ...
    role: "assistant",
    content:
      "The Project A Acquisition is progressing well at 65% completion. The NDA has been signed, and the financial model is currently under review. The DD team is making good progress on their report, expected to complete in 5 days. Would you like me to schedule a status call with the team?",
  ...
  },
  {
    ...
    role: "user",
    content:
      "Yes, and also draft an email to the Project A CFO requesting the Q3 financials",
...
export const sampleNotifications = [
  {
    ...
    message:
      "The Project A financial model needs your review before submission",
...
export const sampleVoiceNotes = [
  {
    id: "vn-1",
    transcript:
      "Remember to follow up with the Project A team about the revised timeline. They mentioned concerns about the Q4 deadline.",
    category: "reminder",
  ...
  },
  {
    id: "vn-2",
    transcript:
      "Idea for the Sample Project partnership: propose a revenue share model instead of flat fee. Could be more attractive to both parties.",
    category: "idea",
  ...
  },
  {
    id: "vn-3",
    transcript:
      "Need to check if the Perfect DXB property has any outstanding liens or encumbrances before proceeding.",
    category: "task",
