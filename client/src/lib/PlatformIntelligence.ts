...
export const platformIntelligence: Record<string, PlatformData> = {
    ...
    contentTypes: [
      {
        type: "Reels",
        priority: 1,
        description: "Short form video content, highest reach potential",
      },
      {
        type: "Carousels",
        priority: 2,
        description: "Multiple images/slides, high engagement",
      },
      {
        type: "Stories",
        priority: 3,
        description: "Ephemeral content, great for engagement",
      },
      {
        type: "Static Posts",
        priority: 4,
        description: "Single image posts, lower reach but still valuable",
      },
    ],
    algorithmFactors: [
      {
        ...
        weight: "high",
        description: "Likes, comments, shares, and saves within first hour",
        tips: [
          "Post when audience is most active",
          "Use engaging captions with questions",
      ...
      },
      {
        factor: "Watch Time",
        weight: "high",
        description: "How long users watch your Reels",
        tips: [
          "Hook viewers in first 3 seconds",
          "Keep Reels under 30 seconds for completion",
          "Use trending audio",
        ],
      },
      {
        factor: "Saves & Shares",
        weight: "high",
        description: "Content saved or shared to stories/DMs",
        tips: [
      ...
      {
        factor: "Hashtag Relevance",
        weight: "medium",
        description: "Using relevant, not banned hashtags",
        tips: [
    ...
    contentTypes: [
      {
        type: "Shorts",
        priority: 1,
        description: "Vertical short form videos, massive reach",
      },
      {
        type: "Long Form",
        priority: 2,
        description: "Traditional YouTube videos, best for monetization",
      },
      {
        type: "Live Streams",
        priority: 3,
        description: "Real time engagement, builds community",
      },
      {
        type: "Community Posts",
        priority: 4,
        description: "Text and image posts for engagement",
      },
    ],
    algorithmFactors: [
      {
        factor: "Watch Time",
        weight: "high",
        description: "Total minutes watched on your videos",
        tips: [
          "Create compelling intros",
          "Use pattern interrupts every 30 seconds",
          "Deliver on your title promise",
        ],
      },
      {
        factor: "Click Through Rate",
        weight: "high",
        description: "Percentage of impressions that become views",
        tips: [
          "A/B test thumbnails",
      ...
      {
        factor: "Audience Retention",
        weight: "high",
        description: "How much of your video viewers watch",
        tips: [
          "Front load value",
          "Use chapters for navigation",
          "Cut ruthlessly, remove fluff",
        ],
      },
      {
        factor: "Session Time",
        weight: "medium",
        description: "How long viewers stay on YouTube after your video",
        tips: [
          "Create playlists",
      ...
      },
      {
        factor: "Engagement",
        weight: "medium",
        description: "Likes, comments, and subscriptions",
        tips: [
  ...
  tiktok: {
    ...
    contentTypes: [
      {
        type: "Trending Sounds",
        priority: 1,
        description: "Videos using viral audio",
      },
      {
        type: "Duets/Stitches",
        priority: 2,
        description: "Collaborative content with other creators",
      },
      {
        type: "Original Content",
        priority: 3,
        description: "Unique creative videos",
      },
      {
        type: "Educational",
        priority: 4,
        description: "Quick tips and tutorials",
      },
    ],
    algorithmFactors: [
      {
        ...
        tips: [
          "Keep videos under 15 seconds initially",
          "Use loops that encourage rewatches",
          "Front load the hook",
        ],
      },
      {
        factor: "Rewatch Rate",
        weight: "high",
        description: "How often viewers replay your video",
        tips: [
          "Create satisfying loops",
          "Include hidden details",
          "Use text that requires pause",
        ],
      },
      {
        factor: "Shares",
        weight: "high",
        description: "Videos shared to other platforms or DMs",
        tips: [
          "Create relatable content",
          "Use humor effectively",
          "Make content people want to tag friends in",
        ],
      },
      {
        factor: "Trending Audio",
        weight: "medium",
        description: "Using sounds that are currently viral",
        tips: [
          "Check trending sounds daily",
          "Put your spin on trends",
          "Act fast on new trends",
        ],
      },
      {
        factor: "Comments",
        weight: "medium",
        description: "Number and quality of comments",
        tips: [
          "Ask controversial questions",
          "Leave things slightly unfinished",
    ...
    contentTypes: [
      {
        type: "Text Posts",
        priority: 1,
        description: "Native text posts with line breaks",
      },
      {
        type: "Document Posts",
        priority: 2,
        description: "PDF carousels and slideshows",
      },
    ...
    algorithmFactors: [
      {
        ...
        tips: [
          ...
          "Tell stories that hook readers",
          "Use the see more effectively",
        ],
      },
      {
        factor: "Comment Quality",
        weight: "high",
        description: "Meaningful comments, not just emojis",
        tips: [
      ...
      {
        factor: "Native Content",
        weight: "high",
        description: "Content created directly on LinkedIn",
        tips: [
          "Avoid external links in posts",
          "Use LinkedIn native video",
          "Create document posts instead of linking",
        ],
      },
      {
        factor: "Early Engagement",
        weight: "medium",
        description: "Engagement in first 90 minutes",
        tips: [
          "Post when network is active",
          "Engage with others before posting",
          "Notify key connections",
        ],
      },
      {
        factor: "Profile Strength",
        weight: "medium",
        description: "Complete and optimized profile",
        tips: [
...
export function getOptimalPostTime(platform: string, day: string): string[] {
  ...
  if (!data) return [];
  const dayData = data.optimalPostTimes.find(
    d => d.day.toLowerCase() === day.toLowerCase()
  );
  return dayData?.times || [];
}

export function getTopAlgorithmFactors(
  platform: string,
  count: number = 3
): AlgorithmInsight[] {
  const data = platformIntelligence[platform.toLowerCase()];
  if (!data) return [];
  return data.algorithmFactors.filter(f => f.weight === "high").slice(0, count);
}
