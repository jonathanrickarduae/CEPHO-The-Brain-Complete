...
export const BTN_GHOST = "bg-transparent hover:bg-accent text-foreground";
...
/** Success button */
export const BTN_SUCCESS = "bg-green-600 text-white hover:bg-green-700";
...
/** Standard card */
export const CARD_BASE = "rounded-xl border border-border bg-card shadow-sm";
