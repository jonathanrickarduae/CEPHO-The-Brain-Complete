      ...
      const streamInterval = setInterval(
        () => {
          ...
          const newWords = words
            .slice(currentIndex, currentIndex + wordsToAdd)
            .join(" ");
        ...
        30 + Math.random() * 40
      ); // Variable speed: 30-70ms per word chunk
