  ...
  const navigationShortcuts: ShortcutConfig[] = [
    {
      key: "d",
      ctrl: true,
      action: () => setLocation("/nexus"),
      description: "Go to Dashboard",
    },
    {
      key: "b",
      ctrl: true,
      action: () => setLocation("/daily-brief"),
      description: "Go to The Signal",
    },
    {
      key: "e",
      ctrl: true,
      action: () => setLocation("/ai-experts"),
    ...
    },
    {
      key: "v",
      ctrl: true,
      action: () => setLocation("/vault"),
      description: "Go to Vault",
    },
    {
      key: "r",
      ctrl: true,
      action: () => setLocation("/evening-review"),
      description: "Go to Evening Review",
    },
  ];
...
export function useShortcutsList() {
  return GLOBAL_SHORTCUTS.map(s => ({
    key: s.key,
    modifiers: [s.ctrl && "⌘/Ctrl", s.shift && "Shift", s.alt && "Alt"]
      .filter(Boolean)
      .join("+"),
