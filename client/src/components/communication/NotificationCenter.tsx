...
function getSampleNotifications(): Notification[] {
  return [
    ...
    },
    {
      ...
      message:
        "NDA for TechFlow Solutions has been generated and is ready for review.",
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2">
            <p
              className={`font-medium text-sm truncate ${!notification.read ? "text-foreground" : "text-muted-foreground"}`}
            >
              {notification.title}
            </p>
...
export function NotificationBell() {
  ...
  return (
    <div className="relative">
      ...
      >
        <Bell
          className={`w-5 h-5 transition-colors ${unreadCount > 0 ? "text-primary" : "text-muted-foreground hover:text-foreground"}`}
        />
        {unreadCount > 0 && (
