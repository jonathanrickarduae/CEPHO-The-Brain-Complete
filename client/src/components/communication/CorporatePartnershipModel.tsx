...
const partnershipTiers: PartnershipTier[] = [
  {
    ...
    description:
      "Deep, long-term partnerships with co-development and shared go-to-market",
    benefits: [
...
export function CorporatePartnershipModel({
  onTierSelect,
}: CorporatePartnershipModelProps) {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Strategic framework for building and managing corporate
                partnerships
              </CardDescription>
            </div>
            ...
            <Card
              ...
              style={{
                borderColor: isActive
                  ? tier.color.replace("text-", "").replace("-400", "")
                  : undefined,
              }}
              onClick={() => {
            ...
            >
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <h3 className={cn("text-lg font-semibold", tier.color)}>
                    {tier.name}
                  </h3>
                ...
                <div className="flex flex-wrap gap-2">
                  {tier.examples.map((example, index) => (
                    <Badge
                      key={index}
                      variant="outline"
                      className={cn(tier.bgColor, tier.color, "border-0")}
                    >
                      {example}
                    </Badge>
                  ))}
