...
export function TeamCapabilityMatrix() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = trpc.teamCapabilities.list.useQuery();
  ...
  const stats = {
    ...
    avgLevel: capabilities?.length
      ? (
          capabilities.reduce((sum, c) => sum + c.currentLevel, 0) /
          capabilities.length
        ).toFixed(1)
      : "0",
  ...
  // Group data
  const groupedData = capabilities?.reduce(
    (acc, cap) => {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Track skills, gaps, and development plans
          </p>
        </div>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={v =>
                      setNewCapability({ ...newCapability, skillCategory: v })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
              ...
              <div>
                ...
                <Slider
                  ...
                  onValueChange={v =>
                    setNewCapability({ ...newCapability, currentLevel: v[0] })
                  }
                  min={1}
                  max={5}
                  step={1}
              ...
              <div>
                ...
                <Slider
                  ...
                  onValueChange={v =>
                    setNewCapability({ ...newCapability, targetLevel: v[0] })
                  }
                  min={1}
                  max={5}
                  step={1}
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-[#E91E8C]/20 rounded-lg">
                <div className="w-5 h-5 text-[#E91E8C] font-bold text-center leading-5">
                  Ø
                </div>
              </div>
              <div>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Add your first team capability to get started
            </p>
          </CardContent>
        </Card>
      ) : (
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <div className="flex items-center gap-1">
                            ...
                            {cap.targetLevel &&
                              cap.targetLevel > cap.currentLevel && (
                                <>
