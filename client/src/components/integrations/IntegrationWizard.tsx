...
const INTEGRATIONS: Integration[] = [
    ...
    setupSteps: [
      {
        ...
        description:
          "We'll securely connect to your Google account to sync calendar events.",
        type: "info",
      },
      {
        id: "oauth",
        title: "Sign in with Google",
        description: "Click below to authorize access to your calendar.",
        type: "oauth",
      },
      {
        id: "config",
    ...
    setupSteps: [
      {
        ...
        description: "We'll securely connect to your Microsoft account.",
        type: "info",
      },
      {
        id: "oauth",
        title: "Sign in with Microsoft",
        description: "Click below to authorize access.",
        type: "oauth",
      },
      {
        id: "config",
        title: "Configure Sync",
        description: "Choose sync options.",
        type: "config",
        fields: [
          { id: "sync_all", label: "Sync all calendars", type: "checkbox" },
        ],
    ...
    setupSteps: [
      {
        id: "intro",
        title: "Connect Gmail",
        description: "Allow Cepho to read and draft emails on your behalf.",
        type: "info",
      },
      {
        id: "oauth",
  ...
  },
  {
    ...
    setupSteps: [
      ...
      },
      {
        ...
        description: "Click to connect your workspace.",
        type: "oauth",
      },
    ],
  },
    ...
    setupSteps: [
      {
        ...
        title: "Connect Pitch",
        description:
          "Access your Pitch workspace for collaborative presentations.",
        type: "info",
      },
      {
        id: "oauth",
        title: "Sign in with Pitch",
        description: "Click to connect your Pitch account.",
        type: "oauth",
      },
      {
        id: "config",
        ...
        fields: [
          {
            id: "sync_templates",
            label: "Sync presentation templates",
            type: "checkbox",
          },
          {
            id: "auto_export",
            label: "Auto-export to Library",
            type: "checkbox",
          },
        ],
      },
    ...
    setupSteps: [
      {
        ...
        title: "Connect Gamma",
        description:
          "Create AI-generated presentations directly from your content.",
        type: "info",
      },
      {
        id: "oauth",
        title: "Sign in with Gamma",
        description: "Click to connect your Gamma account.",
        type: "oauth",
      },
      {
        id: "config",
        title: "Generation Settings",
        description: "Configure AI presentation options.",
        type: "config",
        fields: [
          {
            id: "default_style",
          ...
          {
            id: "auto_generate",
            label: "Auto-generate from documents",
            type: "checkbox",
          },
        ],
      },
    ...
    setupSteps: [
      {
        id: "intro",
        title: "Connect Zoom",
        description: "Enable meeting scheduling and transcription.",
        type: "info",
      },
      {
        id: "oauth",
        title: "Sign in with Zoom",
        description: "Authorize Zoom access.",
        type: "oauth",
      },
      {
        id: "config",
        title: "Meeting Settings",
        description: "Configure default meeting options.",
        type: "config",
        fields: [
          {
            id: "auto_record",
  ...
  },
  {
    ...
    setupSteps: [
      ...
      },
      {
        id: "oauth",
        title: "Sign in with Microsoft",
        description: "Authorize Teams access.",
        type: "oauth",
      },
    ],
  },
    ...
    setupSteps: [
      {
        id: "intro",
        title: "Connect Slack",
        description: "Add Cepho to your Slack workspace.",
        type: "info",
      },
      {
        id: "oauth",
        title: "Add to Slack",
        description: "Click to install the Slack app.",
        type: "oauth",
      },
      {
        id: "config",
    ...
    setupSteps: [
      {
        ...
        title: "Connect Asana",
        description:
          "Sync your Asana projects and tasks to your dashboard. Your Chief of Staff will learn from project patterns.",
        type: "info",
      },
      {
        id: "oauth",
        ...
        description:
          "Click below to authorize access to your Asana workspaces.",
        type: "oauth",
      },
      {
        id: "workspaces",
        ...
        description:
          "Choose which workspaces to sync (Project A, Sample Project, etc.).",
        type: "config",
        fields: [
          {
            id: "workspace_celadon",
            label: "Project A Project",
            type: "checkbox",
          },
          {
            id: "workspace_boundless",
            label: "Sample Project Project",
            type: "checkbox",
          },
          {
            id: "workspace_other",
      ...
      },
      {
        id: "sync",
        title: "Sync Settings",
        description: "Configure how tasks sync to your dashboard.",
        type: "config",
        fields: [
          {
            id: "sync_assigned",
  ...
  // Security - NordVPN
  {
    ...
    name: "NordVPN",
    description:
      "Secure your connections with NordVPN for enhanced privacy and security",
    ...
    setupSteps: [
      {
        id: "intro",
        title: "Connect NordVPN",
        description:
          "Enhance your security by routing sensitive API calls through NordVPN. This protects your data and masks your location.",
        type: "info",
      },
      {
        id: "apikey",
        title: "NordVPN Credentials",
        description:
          "Enter your NordVPN service credentials. Get these from your NordVPN account dashboard.",
        type: "apikey",
        fields: [
          {
            id: "nord_token",
      ...
      },
      {
        ...
        description: "Configure when to use VPN protection.",
        type: "config",
        fields: [
          {
            id: "auto_connect",
            label: "Auto-connect on sensitive operations",
            type: "checkbox",
          },
          {
            id: "api_routing",
            label: "Route all API calls through VPN",
            type: "checkbox",
          },
          {
            id: "preferred_region",
          ...
          {
            id: "kill_switch",
            label: "Enable kill switch (block if VPN drops)",
            type: "checkbox",
          },
        ],
      },
  ...
  // Project Management - iDeals Dataroom
  {
    ...
    setupSteps: [
      {
        id: "intro",
        title: "Connect iDeals VDR",
        description:
          "Securely connect to your iDeals Virtual Data Room for automatic document sync with investors.",
        type: "info",
      },
      {
        id: "apikey",
        ...
        description:
          "Enter your iDeals API key. Get it from iDeals VDR Settings > API Keys.",
        type: "apikey",
        fields: [
          {
            id: "api_key",
            label: "iDeals API Key",
            type: "password",
            required: true,
            sensitive: true,
      ...
      },
      {
        ...
        description: "Choose which dataroom project to connect.",
        type: "config",
        fields: [
          {
            id: "project_id",
            label: "Dataroom Project",
            type: "select",
            options: [{ value: "auto", label: "Auto-detect from API key" }],
          },
        ],
      },
      {
        ...
        description: "Map Brain Library folders to iDeals dataroom folders.",
        type: "config",
        fields: [
          {
            id: "map_contracts",
            label: "Sync Contracts folder",
            type: "checkbox",
          },
          {
            id: "map_financials",
            label: "Sync Financial Models folder",
            type: "checkbox",
          },
          {
            id: "map_legal",
            label: "Sync Legal Documents folder",
            type: "checkbox",
          },
          {
            id: "map_presentations",
            label: "Sync Investor Presentations folder",
            type: "checkbox",
          },
          {
            id: "auto_publish",
            label: "Auto-publish uploaded documents",
            type: "checkbox",
          },
        ],
      },
    ...
    setupSteps: [
      {
        ...
        description:
          "Integrate with M365 Copilot for enhanced AI capabilities.",
        type: "info",
      },
      {
        id: "apikey",
        title: "API Configuration",
        description: "Enter your Copilot API credentials.",
        type: "apikey",
        fields: [
    ...
    setupSteps: [
      {
        ...
        description: "Connect any REST API to Cepho.",
        type: "info",
      },
      {
        id: "apikey",
        title: "API Details",
        description: "Enter your API configuration.",
        type: "apikey",
        fields: [
          {
            id: "api_name",
    ...
    setupSteps: [
      {
        ...
        description: "Create webhooks to send/receive data.",
        type: "info",
      },
      {
        id: "webhook",
        title: "Webhook Setup",
        description: "Configure your webhook endpoints.",
        type: "webhook",
        fields: [
          {
            id: "webhook_name",
...
export function IntegrationWizard({ onComplete }: IntegrationWizardProps) {
  ...
  const [step, setStep] = useState<
    "select" | "setup" | "approval" | "complete"
  >("select");
  ...
  const tierLabels = {
    basic: {
      ...
      bg: "bg-green-500/10",
      desc: "Essential integrations for getting started",
    },
    standard: {
      label: "Standard",
      color: "text-primary",
    ...
    advanced: {
      ...
      bg: "bg-purple-500/10",
      desc: "Custom APIs and advanced features",
    },
  };
  ...
  const renderSetupStep = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        {(setupStep.type === "apikey" ||
          setupStep.type === "config" ||
          setupStep.type === "webhook") &&
          setupStep.fields && (
            <div className="space-y-4">
        ...
        <div className="flex justify-between pt-6">
          ...
          >
            {currentSetupStep === selectedIntegration.setupSteps.length - 1
              ? "Complete Setup"
              : "Next"}
                ...
                <div key={category}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {integrations.map(integration => {
                      ...
                      const isPending = pendingApprovals.includes(
                        integration.id
                      );
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-2">
                                <span
                                  className={`text-[10px] px-2 py-0.5 rounded ${tierLabels[integration.tier].bg} ${tierLabels[integration.tier].color}`}
                                >
      ...
      {step === "approval" && selectedIntegration && (
        <div className="text-center py-8">
          ...
          <p className="text-muted-foreground mb-6 max-w-md mx-auto">
            Connecting <strong>{selectedIntegration.name}</strong> requires
            approval from your organization's administrator. This ensures
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 mb-6 max-w-md mx-auto">
            <p className="text-sm text-yellow-400">
              ...
              Your IT/Compliance team will review this request and approve or
              deny access.
            </p>
          </div>
      ...
      {step === "complete" && selectedIntegration && (
        <div className="text-center py-8">
          ...
          <p className="text-muted-foreground mb-6">
            <strong>{selectedIntegration.name}</strong> is now connected to
            Cepho. Your credentials are securely stored in the Vault.
          </p>
