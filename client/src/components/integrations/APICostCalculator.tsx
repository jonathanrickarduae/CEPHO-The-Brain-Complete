...
const usageProfiles: UsageProfile[] = [
  {
    id: "light",
    name: "Light",
    description: "10-20 queries/day, basic tasks",
    queriesPerDay: 15,
    avgInputTokens: 500,
  ...
  },
  {
    id: "moderate",
    name: "Moderate",
    description: "50-100 queries/day, regular use",
    queriesPerDay: 75,
    avgInputTokens: 1000,
  ...
  },
  {
    id: "heavy",
    name: "Heavy",
    description: "200+ queries/day, power user",
    queriesPerDay: 250,
    avgInputTokens: 1500,
  ...
  },
  {
    id: "enterprise",
    name: "Enterprise",
    description: "500+ queries/day, team use",
    queriesPerDay: 500,
    avgInputTokens: 2000,
...
export function APICostCalculator() {
  ...
  const profile =
    usageProfiles.find(p => p.id === selectedProfile) || usageProfiles[1];
  ...
  const potentialSavings = mostExpensive
    ? mostExpensive.annualCost - (cheapestProvider?.annualCost || 0)
    : 0;
            ...
            {useCustom && (
              <div className="space-y-2">
                ...
                <div className="text-sm text-muted-foreground">
                  {customQueries} queries/day = {customQueries * 30}{" "}
                  queries/month
                </div>
              </div>
            )}
              ...
              >
                ...
                {provider.freeAllowance && (
                  <div className="mt-2 text-xs text-green-600 flex items-center gap-1">
                    ...
                    Includes {(provider.freeAllowance / 1000000).toFixed(1)}M
                    free tokens/month
                  </div>
                )}
              </div>
