...
const SUGGESTED_INTEGRATIONS: IntegrationSuggestion[] = [
  {
    ...
    name: "Calendar Sync",
    description:
      "Connect Google Calendar or Outlook to enable smart scheduling and meeting prep",
    icon: Calendar,
  ...
  },
  {
    ...
    description:
      "Connect your email to enable AI-powered inbox management and smart replies",
    icon: Mail,
  ...
  },
  {
    ...
    name: "Secure Vault",
    description:
      "Enable encrypted storage for sensitive documents and credentials",
    icon: Shield,
    category: "security",
    priority: "essential",
    setupTime: "1 min",
  ...
  },
  {
    ...
    description:
      "Connect cloud storage to centralize and search all your documents",
    icon: FileText,
    category: "productivity",
  ...
  },
  {
    ...
    description:
      "Connect wearables to optimize your performance based on health data",
    icon: Activity,
    category: "wellness",
    priority: "recommended",
    setupTime: "3 min",
...
export function IntegrationSuggestions({
  ...
  const totalEssential = SUGGESTED_INTEGRATIONS.filter(
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <Badge
                variant="outline"
                className={`${getPriorityColor(topSuggestion.priority)} text-xs`}
              >
                {topSuggestion.priority}
              </Badge>
            </div>
            <div className="text-xs text-muted-foreground">
              {topSuggestion.setupTime} setup
            </div>
          </div>
        ...
        {visibleSuggestions.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-muted-foreground">
              You've connected all recommended integrations. Explore more in
              Settings.
            </p>
          </div>
        ) : (
            ...
            {visibleSuggestions.map(suggestion => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`w-12 h-12 rounded-lg bg-background flex items-center justify-center ${getCategoryColor(suggestion.category)}`}
                  >
