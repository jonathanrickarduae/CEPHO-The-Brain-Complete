          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              <Button
                ...
                className={cn(
                  includeHashtags && "bg-purple-500/20 text-purple-400"
                )}
              >
              ...
              <Button
                ...
                className={cn(
                  includeEmojis && "bg-amber-500/20 text-amber-400"
                )}
              >
                ...
                <div className="flex items-center justify-between text-sm">
                  <span
                    className={cn(
                      ...
                      currentPlatform &&
                        generatedCaption.length > currentPlatform.maxLength &&
                        "text-red-400"
                    )}
                  >
                    {generatedCaption.length} /{" "}
                    {currentPlatform?.maxLength || 0} characters
                  </span>
                  {currentPlatform &&
                    generatedCaption.length > currentPlatform.maxLength && (
              ...
              return (
                <div key={p.id} className={cn("p-3 rounded-lg", p.bgColor)}>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className={cn("font-medium text-sm", p.color)}>
                      {p.name}
                    </span>
                  </div>
