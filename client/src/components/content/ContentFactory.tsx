  ...
  educational: [
    {
      ...
      body: "Here is why this matters for your business...",
      cta: "Save this for later!",
    },
    {
      hook: "[Number] mistakes you are making with [topic]",
      body: "Let me break down each one...",
      cta: "Which one surprised you most?",
    },
    {
      hook: "The secret to [desired outcome] is simpler than you think",
      body: "Here is the framework I use...",
      cta: "Try this and let me know how it goes!",
    },
  ],
  entertaining: [
    {
      hook: "POV: You just [relatable situation]",
      body: "[Humorous take on the situation]",
      cta: "Tag someone who does this!",
    },
    {
      hook: "Behind the scenes of [process/day]",
      body: "[Authentic glimpse into your world]",
      cta: "What do you want to see next?",
    },
    {
      hook: "When [common scenario] happens...",
      body: "[Funny or relatable response]",
      cta: "Drop a [emoji] if this is you!",
    },
  ],
  promotional: [
    {
      hook: "Introducing [product/service]",
      body: "Here is how it solves [problem]...",
      cta: "Link in bio to learn more!",
    },
    {
      hook: "[Customer name] achieved [result] with our help",
      body: "Here is their story...",
      cta: "Ready for your transformation?",
    },
    {
      hook: "Limited time: [offer details]",
      body: "Here is what you get...",
      cta: 'DM "OFFER" to claim yours!',
    },
  ],
  inspirational: [
    {
      hook: "From [starting point] to [achievement]",
      body: "Here is what I learned along the way...",
      cta: "What is your journey?",
    },
    {
      hook: "The moment everything changed for me",
      body: "[Story of transformation]",
      cta: "Share your turning point below!",
    },
    {
      hook: "If I could tell my past self one thing...",
      body: "[Wisdom gained from experience]",
      cta: "What would you tell yours?",
    },
  ],
};
...
export function ContentFactory({ onContentCreate }: ContentFactoryProps) {
  ...
  const handleTemplateSelect = (
    template: (typeof contentTemplates.educational)[0]
  ) => {
    setContent({
      ...content,
      hook: template.hook,
  ...
  const addHashtag = () => {
    if (hashtagInput.trim()) {
      const tag = hashtagInput.startsWith("#")
        ? hashtagInput
        : `#${hashtagInput}`;
      setContent(prev => ({
        ...prev,
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {contentTemplates[
                contentType as keyof typeof contentTemplates
              ].map((template, i) => (
                <Button
                  key={i}
                  variant="outline"
            ...
            <TabsContent value="write" className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  value={content.hook}
                  onChange={e =>
                    setContent({ ...content, hook: e.target.value })
                  }
                  rows={2}
                />
              </div>
              ...
              <div
                className={`text-sm ${charCount.current > charCount.limit ? "text-red-500" : "text-muted-foreground"}`}
              >
              ...
              <div className="border rounded-lg p-4 bg-muted/50">
                ...
                <div className="space-y-2">
                  <p className="font-medium">
                    {content.hook || "Your hook will appear here..."}
                  </p>
                  <p className="text-muted-foreground whitespace-pre-wrap">
                    {content.body || "Your body content..."}
                  </p>
                  <p className="font-medium">
                    {content.cta || "Your call to action..."}
                  </p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            Suggested Formats for {platformIntelligence[selectedPlatform].name}
          </CardTitle>
        </CardHeader>
        <CardContent>
            ...
            {platformIntelligence[selectedPlatform].contentTypes
              ...
              .map((type, i) => (
                <div key={i} className="text-center p-4 border rounded-lg">
                  ...
                  type.type.includes("Reel") ||
                  type.type.includes("Short") ? (
                    <Video className="h-8 w-8 mx-auto mb-2 text-primary" />
                  ) : type.type.includes("Image") ||
                    type.type.includes("Carousel") ? (
