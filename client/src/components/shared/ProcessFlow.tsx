...
const defaultSteps: ProcessStep[] = [
  {
    ...
    description:
      "Understand the business idea, goals, and constraints through structured conversation",
  ...
  },
  {
    ...
    description:
      "Analyze market size, competition, and opportunity using AI SME experts",
    owner: "Strategy SME",
    duration: "2-4 hours",
  ...
  },
  {
    ...
    description:
      "Develop launch plan, channel strategy, and marketing approach",
    owner: "Marketing SME",
    duration: "3-4 hours",
