        ...
        {rewards.map(reward => {
          ...
          return (
            ...
            >
              ...
              {/* Icon */}
              <div
                className={`w-12 h-12 rounded-xl bg-gradient-to-br ${reward.color} flex items-center justify-center mb-3 mx-auto ${
              ...
              {status === "locked" ? (
                <div className="w-full bg-muted rounded-full h-1.5">
                  <div
                    ...
                    style={{
                      width: `${Math.min(100, (currentStreak / reward.streakRequired) * 100)}%`,
                    }}
                  />
                </div>
              ) : status === "available" ? (
