    ...
    <div className="space-y-4">
      ...
      <Card className="bg-card/60 border-border">
        <CardContent className="p-4">
          ...
          <div className="grid grid-cols-4 gap-4 mb-4">
            ...
            <div className="text-center">
              <div
                className={`text-2xl font-bold ${highRiskCount > 0 ? "text-red-400" : "text-green-400"}`}
              >
                {highRiskCount}
              </div>
              <div className="text-xs text-muted-foreground">
      ...
      <div className="flex gap-2 flex-wrap">
        <select
          ...
          onChange={e =>
            setFilterCategory(e.target.value as ChecklistCategory | "all")
          }
          ...
          return (
            <Card key={item.id} className="bg-card/60 border-border">
              <CardContent className="p-0">
                ...
                >
                  <div
                    className={`w-8 h-8 rounded-lg flex items-center justify-center ${getCategoryColor(item.category)}`}
                  >
                  ...
                  <div className="flex items-center gap-2">
                    {item.riskLevel !== "none" && (
                      <AlertTriangle
                        className={`w-4 h-4 ${getRiskColor(item.riskLevel)}`}
                      />
                    )}
                    <Badge
                      variant="outline"
