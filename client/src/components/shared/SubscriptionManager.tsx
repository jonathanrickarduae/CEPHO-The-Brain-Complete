...
const MOCK_SUGGESTIONS: OptimizationSuggestion[] = [
  {
    ...
    description:
      "You're only using 28% of Pro features. Basic plan covers your meeting needs.",
  ...
  },
  {
    ...
    description:
      "You have Teams for communication. Slack hasn't been used in 7 days.",
  ...
  },
  {
    ...
    description:
      "OneDrive is included with Teams. You're barely using Dropbox.",
    ...
    alternative: {
      ...
      features: [
        ...
        "Office integration",
        "Already in your Microsoft plan",
      ],
    },
    priority: "high",
  },
  ...
  },
  {
    ...
    description:
      "You're at seat capacity. Adding 2 more seats would cost £16/month but improve collaboration.",
    potentialSavings: -16,
    priority: "low",
  },
];
...
export function SubscriptionManager({
  ...
  const avgUsage =
    subscriptions.reduce((sum, s) => sum + s.usagePercent, 0) /
  ...
  return (
    <div className="bg-card rounded-xl border border-border overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-emerald-500/20 via-cyan-500/20 to-blue-500/20 p-6 border-b border-border">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Track, analyze, and optimize your SaaS spend
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-black/20 rounded-xl p-4">
            ...
            <p className="text-xs text-muted-foreground">
              {suggestions.filter(s => s.potentialSavings > 0).length}{" "}
              optimizations
            </p>
          </div>
          ...
          <div className="bg-black/20 rounded-xl p-4">
            ...
            <p className={`text-2xl font-bold ${getUsageColor(avgUsage)}`}>
              {avgUsage.toFixed(0)}%
            </p>
            <p className="text-xs text-muted-foreground">
      ...
      <div className="flex border-b border-border">
        {(["overview", "subscriptions", "optimize", "vault"] as const).map(
          tab => (
            <button
              key={tab}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        {sub.connectedAccount || "Not connected"}
                      </p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="mt-4 grid grid-cols-3 gap-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span
                        className={`text-xs font-medium ${getUsageColor(sub.usagePercent)}`}
                      >
                        {sub.usagePercent}%
                      </span>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="h-1.5 bg-muted rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${(sub.seats.used / sub.seats.total) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
                  ...
                  {sug.alternative && (
                    <div className="mt-3 p-3 bg-black/20 rounded-lg">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-green-400">
                          {sug.alternative.cost === 0
                            ? "Free"
                            : formatCurrency(sug.alternative.cost) + "/mo"}
                        </span>
                      </div>
            ...
            <div className="p-4 bg-purple-500/10 border border-purple-500/30 rounded-xl">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    All subscription credentials are encrypted and stored in The
                    Vault
                  </p>
                </div>
              </div>
    ...
    <div className="p-4 bg-card/50 border border-border rounded-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <p
            className={`text-lg font-bold ${roi > 0 ? "text-green-400" : "text-red-400"}`}
          >
            {roi > 0 ? "+" : ""}
            {roi.toFixed(0)}%
          </p>
