      ...
      <CardContent>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <div className="col-span-2 md:col-span-1 text-center p-4 bg-muted/50 rounded-lg">
            <div className={`text-4xl font-bold ${npsColor}`}>
              {stats.npsScore}
            </div>
          ...
          <div className="mt-6">
            <div className="flex h-4 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${(stats.promoters / stats.totalResponses) * 100}%`,
                }}
              />
              <div
                className="bg-yellow-500"
                style={{
                  width: `${(stats.passives / stats.totalResponses) * 100}%`,
                }}
              />
              <div
                className="bg-red-500"
                style={{
                  width: `${(stats.detractors / stats.totalResponses) * 100}%`,
                }}
              />
            </div>
            <div className="flex justify-between text-xs text-muted-foreground mt-2">
