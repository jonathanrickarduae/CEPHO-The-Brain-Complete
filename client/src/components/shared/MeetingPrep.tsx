...
const MOCK_MEETINGS: MeetingBrief[] = [
  {
    ...
    attendees: [
      {
        ...
        notes: [
          "Led our Seed round",
          "Interested in AI/ML companies",
          "Prefers data-driven pitches",
        ],
        linkedinUrl: "#",
      },
    ],
    context:
      "Follow-up meeting to discuss Series B funding. James expressed interest in leading the round during our last call.",
    objectives: [
    ...
    previousInteractions: [
      {
        date: "2 weeks ago",
        summary: "Initial Series B interest call - positive reception",
      },
      {
        date: "3 months ago",
        summary: "Quarterly update - impressed with growth metrics",
      },
    ],
    riskFactors: [
  ...
  },
  {
    ...
    context:
      "Weekly sync to align on Q4 product priorities and resource allocation.",
    objectives: [
    ...
    previousInteractions: [
      {
        date: "Last week",
        summary: "Discussed AI feature scope - need to narrow down",
      },
    ],
    riskFactors: [
        ...
        <Card className="bg-card/60 border-border">
          <CardContent className="p-4">
            <div className="flex items-start justify-between">
              ...
              <Badge
                variant="outline"
                className={getStatusColor(selectedMeeting.prepStatus)}
              >
                {selectedMeeting.prepStatus === "ready"
                  ? "Prep Complete"
                  : selectedMeeting.prepStatus === "in-progress"
                    ? "In Progress"
                    : "Not Started"}
              </Badge>
            </div>
          ...
          {MOCK_MEETINGS.map(meeting => {
            ...
            return (
              ...
              >
                ...
                <Badge
                  variant="outline"
                  className={`${getStatusColor(meeting.prepStatus)} text-xs`}
                >
