...
const QUICK_FIRE_QUESTIONS = [
  // Communication Style
  {
    ...
    question: "Do you prefer direct, concise communication?",
    type: "yesno",
  },
  {
    id: "comm-2",
    category: "communication",
    question: "Do you use emojis in professional messages?",
    type: "yesno",
  },
  {
    id: "comm-3",
    category: "communication",
    question: "Do you prefer bullet points over paragraphs?",
    type: "yesno",
  },
  {
    id: "comm-4",
    category: "communication",
    question: "Do you start emails with small talk?",
    type: "yesno",
  },
  {
    id: "comm-5",
    category: "communication",
    question: "Do you sign off emails formally?",
    type: "yesno",
  },
  ...
  // Decision Making
  {
    id: "dec-1",
    category: "decisions",
    question: "Do you prefer data over intuition for decisions?",
    type: "yesno",
  },
  {
    id: "dec-2",
    category: "decisions",
    question: "Do you consult others before major decisions?",
    type: "yesno",
  },
  {
    id: "dec-3",
    category: "decisions",
    question: "Do you prefer quick decisions over thorough analysis?",
    type: "yesno",
  },
  {
    id: "dec-4",
    category: "decisions",
    question: "Do you document your decision rationale?",
    type: "yesno",
  },
  ...
  // Work Style
  {
    id: "work-1",
    category: "work",
    question: "Do you prefer working in the morning?",
    type: "yesno",
  },
  {
    id: "work-2",
    category: "work",
    question: "Do you multitask frequently?",
    type: "yesno",
  },
  {
    id: "work-3",
    category: "work",
    question: "Do you prefer scheduled meetings over ad-hoc calls?",
    type: "yesno",
  },
  {
    id: "work-4",
    category: "work",
    question: "Do you take breaks every hour?",
    type: "yesno",
  },
  {
    id: "work-5",
  ...
  // Priorities
  {
    id: "pri-1",
    category: "priorities",
    question: "Is work-life balance your top priority?",
    type: "yesno",
  },
  {
    id: "pri-2",
    category: "priorities",
    question: "Do you prioritize family over career advancement?",
    type: "yesno",
  },
  {
    id: "pri-3",
    category: "priorities",
    question: "Is financial security more important than passion?",
    type: "yesno",
  },
  {
    id: "pri-4",
    category: "priorities",
    question: "Do you value recognition over compensation?",
    type: "yesno",
  },
  ...
  },
  {
    id: "per-2",
    category: "personality",
    question: "Do you prefer planning over spontaneity?",
    type: "yesno",
  },
  {
    id: "per-3",
    category: "personality",
    question: "Are you risk-averse?",
    type: "yesno",
  },
  {
    id: "per-4",
...
const SCENARIO_QUESTIONS = [
  {
    ...
    options: [
      ...
      {
        id: "c",
        text: "Help them catch up without mentioning it",
        style: "supportive",
      },
      {
        id: "d",
        text: "Document it and discuss in next 1:1",
        style: "measured",
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "a",
        text: "Be direct and factual, no sugarcoating",
        style: "direct",
      },
      {
        id: "b",
        text: "Frame it positively with silver linings",
        style: "optimistic",
      },
      {
        id: "c",
        text: "Gather the team and discuss openly",
        style: "collaborative",
      },
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        text: "Build a prototype first, then present",
        style: "action",
      },
      {
        id: "b",
        text: "Get buy-in from stakeholders first",
        style: "political",
      },
      {
        id: "c",
        text: "Present data and research to leadership",
        style: "analytical",
      },
      {
        id: "d",
        text: "Start small and prove the concept",
        style: "iterative",
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: "c",
        text: "Delegate what you can, focus on critical",
        style: "leadership",
      },
      {
        id: "d",
        text: "Work through them in order received",
        style: "systematic",
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: "c",
        text: "Defend your approach with reasoning",
        style: "confident",
      },
      {
        id: "d",
...
export function DigitalTwinAccelerator({
  ...
  const [mode, setMode] = useState<
    "overview" | "quickfire" | "scenarios" | "upload" | "customize" | "daily"
  >("overview");
  ...
  const handleFileUpload = (type: "email" | "document") => {
    ...
    const hours =
      type === "email"
        ? TRAINING_VALUES.emailUpload
        : TRAINING_VALUES.documentUpload;
  ...
  const progressPercentage = Math.min(
    100,
    (progress.totalHours / TARGET_HOURS) * 100
  );
      ...
      <div className="bg-gradient-to-r from-primary/20 via-purple-500/20 to-cyan-500/20 p-6 border-b border-border">
        ...
        <div className="mt-4">
          <div className="flex justify-between text-xs text-muted-foreground mb-1">
            ...
            <span>
              {(TARGET_HOURS - progress.totalHours).toLocaleString()} hours to
              full autonomy
            </span>
          </div>
      ...
      <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      15 min • Yes/No questions
                    </p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground mb-3">
                  Rapid questions about your preferences, habits, and
                  communication style.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-xs text-orange-400">
                    +{TRAINING_VALUES.quickFireQuestion}hrs per question
                  </span>
                  <span className="text-xs text-muted-foreground">
                    {progress.quickFireAnswered}/{QUICK_FIRE_QUESTIONS.length}{" "}
                    answered
                  </span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {progress.scenariosCompleted}/{SCENARIO_QUESTIONS.length}{" "}
                    completed
                  </span>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Instant • Bulk training
                    </p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground mb-3">
                  Upload emails, documents, and texts to learn your writing
                  style.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-xs text-green-400">
                    Up to +200hrs per batch
                  </span>
                  <span className="text-xs text-muted-foreground">
                    {progress.emailsUploaded + progress.documentsUploaded} files
                  </span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <span className="text-2xl">
                    {AVATAR_OPTIONS.find(a => a.id === progress.avatar)?.emoji}
                  </span>
                  <span className="text-xs text-muted-foreground">
                    {
                      VOICE_OPTIONS.find(v => v.id === progress.voiceTone)
                        ?.label
                    }{" "}
                    voice
                  </span>
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs text-yellow-400">
                    +{TRAINING_VALUES.dailyCheckIn}hr per check-in
                  </span>
                  <span className="text-xs text-muted-foreground">
                    {progress.dailyCheckIns} check-ins
                  </span>
                </div>
              </button>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground">
                      {progress.quickFireAnswered *
                        TRAINING_VALUES.quickFireQuestion}
                      hrs
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground">
                      {progress.scenariosCompleted *
                        TRAINING_VALUES.scenarioQuestion}
                      hrs
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground">
                      {(
                        progress.emailsUploaded * TRAINING_VALUES.emailUpload
                      ).toFixed(0)}
                      hrs
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground">
                      {progress.dailyCheckIns * TRAINING_VALUES.dailyCheckIn}hrs
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-xl mx-auto">
            ...
            <div className="h-1 bg-card rounded-full mb-8">
              <div
                ...
                style={{
                  width: `${((currentQuestionIndex + 1) / QUICK_FIRE_QUESTIONS.length) * 100}%`,
                }}
              />
            </div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="h-1 bg-card rounded-full mb-8">
              <div
                ...
                style={{
                  width: `${((currentScenarioIndex + 1) / SCENARIO_QUESTIONS.length) * 100}%`,
                }}
              />
            </div>
        ...
        {mode === "upload" && (
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              Upload your communications to accelerate training. Your Chief of
              Staff will learn your writing style, vocabulary, and tone.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-6 bg-card/50 border border-border rounded-xl">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Export your sent emails from Gmail or Outlook. Each email ={" "}
                  {TRAINING_VALUES.emailUpload} training hours.
                </p>
                <button
              ...
              <div className="p-6 bg-card/50 border border-border rounded-xl">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Upload reports, memos, or any documents you've written. Each
                  doc = {TRAINING_VALUES.documentUpload} training hours.
                </p>
                <button
              ...
              <div className="p-6 bg-card/50 border border-border rounded-xl">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Record voice samples to train speech patterns. Each sample ={" "}
                  {TRAINING_VALUES.voiceSample} training hours.
                </p>
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
                {AVATAR_OPTIONS.map(avatar => (
                  <button
                    key={avatar.id}
                    onClick={() =>
                      setProgress(prev => ({ ...prev, avatar: avatar.id }))
                    }
              ...
              <div className="space-y-2">
                {VOICE_OPTIONS.map(voice => (
                  <button
                    key={voice.id}
                    onClick={() =>
                      setProgress(prev => ({ ...prev, voiceTone: voice.id }))
                    }
        ...
        {mode === "daily" && (
          <div className="max-w-xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Quick 2-minute check-ins that compound over time. Your Chief of
              Staff learns from your daily patterns.
            </p>
            ...
            <p className="text-xs text-muted-foreground">
              ...
              {progress.dailyCheckIns * TRAINING_VALUES.dailyCheckIn} hours
              earned
            </p>
          </div>
        )}
