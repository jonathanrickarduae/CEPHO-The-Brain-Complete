...
const sampleDocuments: ProcessDocument[] = [
  {
    ...
    versions: [
      {
        ...
        date: "2024-01-12",
        author: "digital_twin",
        changes: "Added SME collaboration framework",
        signedOffBy: ["digital_twin", "user"],
      },
      {
        version: "1.1.0",
        date: "2024-01-10",
        author: "user",
        changes: "Enhanced QA requirements",
        signedOffBy: ["user"],
      },
      {
        version: "1.0.0",
    ...
    description:
      "Master document defining the Project Genesis methodology and all sub-processes",
  },
  {
    id: "pg-social",
    code: "PG-BP-002",
    ...
    versions: [
      {
        ...
        date: "2024-01-12",
        author: "digital_twin",
        changes: "Added platform intelligence layer",
        signedOffBy: ["digital_twin"],
      },
      {
        version: "0.8.0",
        date: "2024-01-11",
    ...
    owner: "Chief of Staff",
    description:
      "End-to-end social media strategy and content generation process",
  },
  {
    id: "pg-presentation",
    code: "PG-BP-003",
    ...
    versions: [
      {
        ...
        date: "2024-01-11",
        author: "digital_twin",
        changes: "Added valuation frameworks",
        signedOffBy: [],
      },
    ],
    linkedDocuments: ["pg-master"],
  ...
  },
  {
    ...
    versions: [
      {
        ...
        date: "2024-01-12",
        author: "both",
        changes: "Comprehensive role definition",
        signedOffBy: ["digital_twin", "user"],
      },
    ],
    linkedDocuments: [],
    ...
    owner: "User",
    description:
      "Defines all responsibilities, communication protocols, and QA duties of the Chief of Staff",
  },
];
...
const sampleAuditLog: AuditLogEntry[] = [
  {
    ...
    action: "updated",
    documentId: "pg-social",
    documentName: "Social Media Blueprint",
    actor: "digital_twin",
    details:
      "Added platform intelligence layer for Instagram, YouTube, TikTok, LinkedIn",
  },
  {
    id: "2",
    timestamp: "2024-01-12 15:30",
    action: "cascaded",
    documentId: "pg-master",
    documentName: "Project Genesis Master Blueprint",
    actor: "digital_twin",
    details: "SME framework update cascaded to linked documents",
    cascadedTo: ["pg-social", "pg-presentation", "pg-financial"],
  },
  {
    id: "3",
    ...
    documentName: "Project Genesis Master Blueprint",
    actor: "user",
    details: "User approved version 1.2.0",
  },
  {
    id: "4",
    ...
    documentName: "Project Genesis Master Blueprint",
    actor: "digital_twin",
    details: "Weekly audit completed, 3 enhancement suggestions",
  },
  {
    id: "5",
    timestamp: "2024-01-12 10:00",
    action: "created",
    documentId: "pg-presentation",
    documentName: "Presentation Blueprint",
    actor: "digital_twin",
    details: "Initial document created",
  },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-1 p-1 bg-card/50 rounded-lg border border-white/10">
        {[
          ...
          <button
            key={tab.id}
            onClick={() => setActiveTab(tab.id as "dependencies" | "documents" | "audit")}
          ...
          <div className="space-y-3">
            {filteredDocs.map(doc => {
              ...
              return (
                <div
                  key={doc.id}
                  className="bg-card/50 rounded-xl border border-white/10 overflow-hidden"
                >
                  <button
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge
                            variant="outline"
                            className={`${statusConf.bgColor} ${statusConf.color} ${statusConf.borderColor}`}
                          >
                            {statusConf.label}
                          </Badge>
                        </div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {doc.category} • v{doc.currentVersion}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <div className="mb-4">
                        ...
                        <div className="space-y-2">
                          {doc.versions.map((v, i) => (
                            <div
                              key={i}
                              className="flex items-center gap-3 text-sm p-2 bg-black/20 rounded-lg"
                            >
        ...
        <div className="space-y-3">
          {auditLog.map(entry => {
            ...
            return (
              <div
                key={entry.id}
                className="p-4 bg-card/50 rounded-xl border border-white/10 flex items-start gap-4"
              >
                <div
                  className={`w-10 h-10 rounded-lg bg-black/20 flex items-center justify-center ${color}`}
                >
        ...
        <div className="p-8 bg-card/50 rounded-xl border border-white/10">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex gap-4">
              {["Social Media", "Presentation", "Financial Model"].map(
                (name, i) => (
                  <div
                    key={i}
                    className="p-3 bg-card/50 rounded-lg border border-white/10 w-40 text-center"
                  >
            ...
            <p className="text-xs text-muted-foreground mt-4">
              Changes to the Master Blueprint automatically trigger review of
              linked documents
            </p>
          </div>
        </div>
