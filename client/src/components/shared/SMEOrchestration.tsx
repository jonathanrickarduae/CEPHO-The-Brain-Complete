...
const DEMO_SELECTED_EXPERTS: Expert[] = [
  {
    ...
    status: "complete",
    insight:
      "Deal structure appears standard for this sector. However, the earnout provisions seem aggressive - typically see 20-30% tied to performance, this has 45%.",
  ...
  },
  {
    ...
    status: "complete",
    insight:
      "Market growing at 12% CAGR through 2030. Key risk: regulatory changes in EU could impact 40% of projected revenue. Recommend stress-testing against new EU directive.",
  ...
  },
  {
    ...
    status: "working",
    insight:
      "Reviewing current permits against 2026 EU directive requirements...",
    confidence: 0,
  },
  {
    id: "4",
...
export function SMEOrchestration({
        ...
        const updated = prev.map(expert => {
          if (expert.status === "working" && Math.random() > 0.7) {
            return {
              ...
              source:
                expert.id === "3"
                  ? "EU Environmental Agency, Company filings"
                  : "Company financials, Comparable transactions",
  ...
  const completedCount = selectedExperts.filter(
    e => e.status === "complete"
  ).length;
          ...
          <div className="mt-3 space-y-2">
            {excludedExperts.map(expert => (
              ...
              >
                ...
                <p className="text-xs text-foreground/60 max-w-[200px] text-right">
                  {expert.reason}
                </p>
              </div>
            ))}
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <div className="text-sm text-foreground/80 space-y-2">
                <p>
                  <strong>Assessment:</strong> Based on input from 4 experts,
                  this appears to be a viable investment with manageable risks.
                </p>
                <p>
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground/70">
                  <li>
                    Valuation range €45-58M is reasonable given market
                    comparables
                  </li>
                  <li>
                    Earnout structure (45%) is aggressive - recommend
                    negotiating to 30%
                  </li>
                  <li>
                    EU regulatory compliance requires €2.3M investment by 2026
                  </li>
                  <li>
                    Market fundamentals strong (12% CAGR) but regulatory risk
                    material
                  </li>
                </ul>
                <p className="mt-2">
                  <strong>Gap Identified:</strong> Technology due diligence not
                  yet complete. Recommend adding Technical Expert to assess
