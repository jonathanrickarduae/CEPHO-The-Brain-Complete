...
export function MindfulnessPrompts({
  ...
  useEffect(() => {
    if (selectedExercise && isPlaying) {
      const stepDuration =
        selectedExercise.duration / selectedExercise.steps.length;
  ...
  if (selectedExercise) {
    const progress =
      ((selectedExercise.duration - timeRemaining) /
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div
                className={`w-12 h-12 rounded-full ${selectedExercise.bgColor} flex items-center justify-center`}
              >
          ...
          <div className="text-center mb-6">
            <div
              className={`text-5xl font-bold ${selectedExercise.color} mb-2`}
            >
  ...
  return (
    <Card className="bg-card/60 border-border">
      <CardContent className={compact ? "p-3" : "p-4"}>
        ...
        <div
          className={`grid ${compact ? "grid-cols-2 gap-2" : "grid-cols-1 gap-3"}`}
        >
