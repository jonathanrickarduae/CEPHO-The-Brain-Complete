...
const MOCK_PATTERNS: WorkflowPattern[] = [
  {
    ...
    type: "success",
    description:
      "High-value tasks completed 40% faster when scheduled before 11am",
    frequency: "Daily",
    impact: "high",
    trend: "improving",
    occurrences: 45,
  ...
  },
  {
    ...
    type: "bottleneck",
    description:
      "Legal document reviews consistently delay deal progression by 3-5 days",
    frequency: "Per deal",
    impact: "high",
    trend: "stable",
    occurrences: 12,
    ...
    recommendation:
      "Pre-schedule legal review slots or add parallel review capacity",
  },
  {
    id: "p3",
    ...
    type: "risk",
    description:
      "Fridays with 4+ meetings correlate with 60% lower task completion",
    frequency: "Weekly",
    impact: "medium",
    trend: "declining",
    occurrences: 8,
  ...
  },
  {
    ...
    type: "efficiency",
    description:
      "Investor queries answered within 2 hours have 3x higher conversion",
...
export function WorkflowPatternDetection() {
  ...
  const getTrendIcon = (trend: string) => {
    switch (trend) {
      ...
      default:
        return <ArrowRight className="w-4 h-4 text-foreground/70" />;
    }
  };
              ...
              <Card key={pattern.id} className="bg-card/60 border-border">
                <CardContent className="p-4">
                  <div className="flex items-start gap-4">
                    <div
                      className={`w-10 h-10 rounded-lg flex items-center justify-center ${getPatternColor(pattern.type)}`}
                    >
