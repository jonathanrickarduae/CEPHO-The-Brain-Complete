...
export function Sparkle({
  ...
  return (
    <div className={cn("relative", className)} onMouseEnter={addSparkle}>
      {children}
      ...
      <div className="relative">
        <Flame
          ...
          style={{
            filter:
              intensity > 0.5
                ? `drop-shadow(0 0 ${intensity * 10}px rgba(251, 146, 60, 0.5))`
                : "none",
          }}
        />
        {intensity > 0.7 && (
          <Flame className="absolute inset-0 w-6 h-6 text-red-500 animate-ping opacity-30" />
        )}
      </div>
