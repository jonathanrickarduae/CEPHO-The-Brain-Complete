...
const EMPTY_STATE_CONFIGS: Record<EmptyStateType, EmptyStateConfig> = {
  projects: {
    ...
    description:
      "Start your first project and let your AI team help you bring it to life.",
  ...
  inbox: {
    ...
    title: "All caught up!",
    description:
      "No pending items require your attention. Your Chief of Staff is on it.",
  ...
  insights: {
    ...
    description:
      "As you use Cepho more, your Chief of Staff will surface personalized insights here.",
    color: "text-primary",
  ...
  training: {
    ...
    description:
      "The more you interact, the smarter your Chief of Staff becomes. Start a conversation!",
  ...
  goals: {
    ...
    description:
      "Define what success looks like and let Cepho help you get there.",
