...
const PERSONAL_SMES = [
  {
    id: "travel",
    name: "Travel & Hospitality Expert",
    description: "Flights, hotels, experiences, and travel logistics",
    icon: Plane,
  },
  {
    id: "dining",
    name: "Dining & Entertainment Specialist",
    description: "Restaurants, events, venues, and reservations",
    icon: Utensils,
  },
  {
    id: "wellness",
    name: "Wellness & Health Advisor",
    description: "Fitness, medical appointments, and wellbeing",
    icon: User,
  },
  {
    id: "home",
    name: "Home & Lifestyle Manager",
    description: "Services, maintenance, and personal errands",
    icon: Building2,
  },
  {
    id: "concierge",
    name: "Concierge Specialist",
    description: "Luxury services and special requests",
    icon: Star,
  },
];
...
const CAPABILITY_CATEGORIES: CapabilityCategory[] = [
    ...
    capabilities: [
      {
        ...
        description: "Manage and prioritize tasks across projects",
        status: "available",
        phase: 1,
        icon: CheckCircle2,
      },
      {
        ...
        description: "Create reports, briefs, and presentations",
        status: "available",
        phase: 1,
        icon: FileText,
      },
      {
        ...
        description: "Prepare agendas, briefings, and follow-ups",
        status: "available",
        phase: 2,
        icon: Calendar,
      },
      ...
      },
      {
        id: "b5",
        name: "Email Drafting",
        description: "Draft and manage professional correspondence",
  ...
  },
  {
    ...
    description:
      "Personal life management with lifestyle SME experts (Phase 4)",
    icon: User,
    ...
    capabilities: [
      {
        ...
        description: "Schedule and coordinate appointments",
        status: "available",
        phase: 1,
        icon: Calendar,
      },
      ...
      },
      {
        ...
        description: "Research and plan travel arrangements",
        status: "in_development",
        phase: 3,
        icon: Plane,
      },
      {
        ...
        description:
          "Autonomous restaurant research, outreach, and booking workflow",
        status: "planned",
        phase: 4,
        icon: Utensils,
  ...
  },
  {
    ...
    capabilities: [
      {
        id: "a1",
        name: "Internal AI Coordination",
        description: "Coordinate with CEPHO AI SME experts",
        status: "available",
        phase: 1,
        icon: Brain,
      },
      {
        ...
        description: "Multi-layer AI review and approval",
        status: "available",
        phase: 2,
        icon: CheckCircle2,
      },
    ...
    capabilities: [
      {
        ...
        description: "Manage team tasks and communications",
        status: "in_development",
        phase: 3,
        icon: User,
      },
...
const getPhaseLabel = (phase: number) => {
  switch (phase) {
    ...
    case 2:
      return "Phase 2: Enhancement";
    case 3:
      return "Phase 3: Market Entry";
    case 4:
      return "Phase 4: Personal (AI Integration)";
    case 5:
      return "Phase 5: In-house Productivity Apps";
    case 6:
      return "Phase 6: Commercialization";
    default:
      return `Phase ${phase}`;
  }
};
...
export function ChiefOfStaffRoadmap() {
  ...
  const totalCapabilities = CAPABILITY_CATEGORIES.reduce(
    (acc, cat) => acc + cat.capabilities.length,
    0
  );
  const availableCapabilities = CAPABILITY_CATEGORIES.reduce(
    (acc, cat) =>
      acc + cat.capabilities.filter(c => c.status === "available").length,
    0
  );
  const inDevelopment = CAPABILITY_CATEGORIES.reduce(
    (acc, cat) =>
      acc + cat.capabilities.filter(c => c.status === "in_development").length,
    0
  );
      ...
      <Card className="bg-gray-900/50 border-gray-800">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Progress
              value={(availableCapabilities / totalCapabilities) * 100}
              className="h-3"
            />
          </div>
        </CardContent>
                          ...
                          {capability.aiAgentIntegration && (
                            <div className="mt-4 p-3 bg-cyan-500/10 rounded-lg border border-cyan-500/20">
                              ...
                              <p className="text-xs text-muted-foreground">
                                ...
                                communicate with external AI agents. When a
                                business has an AI agent, the Chief of Staff can
                                speak directly to it to negotiate, gather
                                information, and complete transactions on your
                                behalf.
                              </p>
                            </div>
                          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-gray-800/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Full end-to-end booking automation: research venues, contact
                them via email and forms, collect responses, analyze options
                with pros and cons, present recommendations, and execute
            ...
            <div className="p-4 bg-gray-800/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                When businesses deploy their own AI agents, your Chief of Staff
                will be able to communicate directly with them, handling
                negotiations and transactions seamlessly in the background.
              </p>
            </div>
          </div>
        </CardContent>
