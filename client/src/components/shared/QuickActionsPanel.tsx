  ...
  return (
    <div className="space-y-3">
        ...
        {actions.map(action => (
          ...
          >
            <div className="flex items-start justify-between mb-2">
              <div className="p-2 bg-current/10 rounded-md">{action.icon}</div>
                ...
                return (
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Calendar will open with a 1-hour slot at your next
                      available time.
                    </p>
              ...
              case "email":
                return (
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Email draft will be created with suggested recipients
                      based on context.
                    </p>
                    <div className="flex gap-2">
                      <Button size="sm" variant="outline">
              ...
              case "task":
                return (
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Task will be added to your list with priority based on
                      urgency.
                    </p>
                    <div className="flex gap-2">
                      <Button size="sm" variant="outline">
      ...
      <div className="bg-primary/5 rounded-lg p-3 border border-primary/20 text-xs text-muted-foreground">
        <p>
          <span className="font-medium text-foreground">Tip:</span> These quick
          actions learn from your patterns and adapt over time.
        </p>
      </div>
    </div>
  );
