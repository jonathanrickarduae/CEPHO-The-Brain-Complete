...
export function EndOfDayWashUp({ isOpen, onComplete }: EndOfDayWashUpProps) {
  const [step, setStep] = useState<
    "review" | "tomorrow" | "rating" | "goodnight"
  >("review");
  const [tasks, setTasks] = useState<Task[]>([
    ...
    {
      id: "2",
      title: "Call with legal team",
      completed: true,
      carryForward: false,
    },
    {
      id: "3",
      title: "Finalize Q1 projections",
      completed: false,
      carryForward: false,
    },
    {
        ...
        {step === "rating" && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center mb-8">
              ...
              <p className="text-foreground/70 text-sm">
                Rate your day on the 100% Optimization Scale
              </p>
            </div>
          ...
          <div className="animate-in fade-in zoom-in duration-1000 text-center">
            <div className="mb-8">
              ...
              <div className="relative w-32 h-32 mx-auto mb-6">
                ...
                <div
                  className="absolute inset-4 bg-gradient-to-b from-cyan-500/30 to-purple-500/30 rounded-full blur-xl animate-pulse"
              ...
              <h2
                className="text-3xl font-bold text-white animate-in fade-in duration-1000"
                style={{ animationDelay: "0.5s" }}
              >
                Goodnight.
              </h2>
