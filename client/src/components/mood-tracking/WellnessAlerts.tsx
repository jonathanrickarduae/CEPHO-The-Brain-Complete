...
const MOCK_ALERTS: BurnoutAlert[] = [
  {
    ...
    recommendation:
      "Consider ending your workday earlier tomorrow. Schedule a recovery day this week.",
  ...
  },
  {
    ...
    recommendation:
      "Try to consolidate or reschedule 2 meetings. Block 2 hours for focused work.",
  ...
  },
  {
    ...
    recommendation:
      "Take a 10-minute walk or stretch. Your productivity will improve.",
...
export function WellnessAlerts() {
  ...
  const overallScore = Math.round(
    (indicators.filter(i => i.status === "healthy").length /
      indicators.length) *
      100
  );
