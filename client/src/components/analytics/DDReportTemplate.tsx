      ...
      <div className="max-w-[210mm] mx-auto bg-white shadow-lg print:shadow-none">
        ...
        <div className="min-h-[297mm] p-12 flex flex-col relative page-break-after">
          ...
          <div className="grid grid-cols-2 gap-8 pt-8 border-t border-gray-200">
            ...
            <div>
              ...
              <div
                className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${getRecommendationColor(data.recommendation)}`}
              >
        ...
        <div className="min-h-[297mm] p-12 relative page-break-after">
          ...
          >
            ...
            <div className="flex items-center justify-between py-2 border-b border-gray-100">
              <span className="text-gray-900">
                {data.sections.length + 4}. Risk Register
              </span>
              <span className="text-foreground/60">
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="text-xl font-bold text-gray-900">
                {formatCurrency(
                  data.valuation.lowRange,
                  data.valuation.currency
                )}{" "}
                -{" "}
                {formatCurrency(
                  data.valuation.highRange,
                  data.valuation.currency
                )}
              </div>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="text-xl font-bold text-gray-900">
                {data.sections.reduce(
                  (acc, s) =>
                    acc + s.risks.filter(r => r.level === "high").length,
                  0
                )}{" "}
                High Priority
              </div>
        ...
        <div className="min-h-[297mm] p-12 relative page-break-after">
          ...
          <div
            className={`p-8 rounded-xl ${getRecommendationColor(data.recommendation)} mb-8`}
          >
            <div className="flex items-center gap-4">
              {data.recommendation === "proceed" && (
                <CheckCircle className="w-12 h-12" />
              )}
              {data.recommendation === "proceed_with_caution" && (
                <AlertTriangle className="w-12 h-12" />
              )}
              {data.recommendation === "do_not_proceed" && (
              ...
              <div>
                ...
                <div className="text-lg opacity-80 mt-1">
                  Based on comprehensive due diligence analysis
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-gray-700">
              Based on our analysis of {data.sections.length} key areas, review
              of documentation, and open-source intelligence gathering, we
              recommend the above course of action.
            </p>
        ...
        {data.sections.map((section, idx) => (
          <div
            key={section.id}
            className="min-h-[297mm] p-12 relative page-break-after"
          >
            <h2
              className="text-2xl font-bold text-gray-900 mb-2"
              style={{ fontFamily: "Calibri, sans-serif" }}
        ...
        <div className="min-h-[297mm] p-12 relative page-break-after">
          ...
          <div className="bg-gray-50 rounded-xl p-8 mb-8">
            <div className="text-center mb-8">
              <div className="text-sm text-foreground/60 mb-2">
                Valuation Range ({data.valuation.method})
              </div>
              <div className="text-4xl font-bold text-gray-900">
                {formatCurrency(
                  data.valuation.midRange,
                  data.valuation.currency
                )}
              </div>
          ...
          >
            ...
            <p className="text-gray-700">
              The valuation has been derived using {data.valuation.method}{" "}
              methodology, cross-referenced with comparable transactions and
              market multiples.
            </p>
          </div>
        ...
        <div className="min-h-[297mm] p-12 relative page-break-after">
          ...
          <p
            ...
            style={{ fontFamily: "Calibri, sans-serif" }}
          >
            The following questions have been identified during the due
            diligence process and require clarification from the target
        ...
        <div className="min-h-[297mm] p-12 relative">
          ...
          <p
            ...
            style={{ fontFamily: "Calibri, sans-serif" }}
          >
            This report has been reviewed and approved by the following AI-SME
            experts:
          </p>
