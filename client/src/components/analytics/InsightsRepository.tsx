...
const MOCK_INSIGHTS: Insight[] = [
  {
    ...
    content:
      "Analysis of Q4 2025 data shows companies with AI-native operations achieving 3x revenue growth compared to traditional competitors in the same sectors. Key differentiators include automated decision-making, predictive analytics, and personalized customer experiences.",
    type: "market_trend",
  ...
  },
  {
    ...
    content:
      "Survey of 500 enterprise customers reveals 78% prefer subscription-based pricing over perpetual licenses. Key drivers: predictable costs, continuous updates, and flexibility to scale.",
  ...
  },
  {
    ...
    content:
      "The EU AI Act enforcement timeline has been accelerated. High-risk AI systems must comply by Q3 2026. Recommend immediate audit of AI systems for classification and compliance gaps.",
    type: "risk_signal",
  ...
  },
  {
    ...
    content:
      "CloudScale is actively seeking AI platform partners for their enterprise marketplace. Their customer base of 2,000+ enterprises aligns with our target market. Initial conversations indicate strong interest.",
    type: "opportunity",
  ...
  },
  {
    ...
    content:
      "Intelligence indicates Competitor X will announce their enterprise AI assistant at TechSummit 2026 (March). Features overlap with our Chief of Staff offering. Recommend accelerating differentiation strategy.",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Searchable knowledge base from surveys, SME assessments, and expert
            conversations
          </p>
        </div>
          ...
          <DialogContent>
            ...
            <div className="space-y-4 mt-4">
              <Input
                ...
                onChange={e =>
                  setNewInsight({ ...newInsight, title: e.target.value })
                }
              />
              <Textarea
              ...
              <Select
                ...
                onValueChange={v =>
                  setNewInsight({ ...newInsight, type: v as InsightType })
                }
              >
                <SelectTrigger>
              ...
              <Input
                ...
                onChange={e =>
                  setNewInsight({ ...newInsight, tags: e.target.value })
                }
              />
              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          className={
                            insight.isBookmarked ? "text-yellow-400" : ""
                          }
                        >
                    ...
                    <p
                      className={`mt-2 text-muted-foreground ${isExpanded ? "" : "line-clamp-2"}`}
                    >
                      {insight.content}
                    </p>
