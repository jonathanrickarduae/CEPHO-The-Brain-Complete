...
const MOCK_ASSETS: Asset[] = [
  {
    ...
    type: "document",
    project: "Project A",
    tags: ["Project A", "Financial", "Final"],
  ...
  },
  {
    ...
    type: "data",
    project: "Project A",
    tags: ["Project A", "Due Diligence", "High Priority"],
  ...
  },
  {
    ...
    type: "document",
    project: "Project B",
    tags: ["Project B", "Legal", "Confidential", "Final"],
...
export function MetadataTagging({ assetId: _assetId }: MetadataTaggingProps) {
  ...
  const filteredAssets = assets.filter(asset => {
    if (
      ...
      !selectedTags.some(t => asset.tags.includes(t))
    ) {
      return false;
    }
    if (
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Organize and find assets across all projects
              </p>
            </div>
        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          {selectedTags.map(tagName => {
            ...
            return (
              ...
              >
                <span
                  className={`w-2 h-2 rounded-full ${tag?.color || "bg-gray-500"} mr-1`}
                />
                {tagName}
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {categoryTags.map(tag => (
                    ...
                    >
                      <span
                        className={`w-2 h-2 rounded-full ${tag.color} mr-1`}
                      />
                      {tag.name}
                    ...
                    <div className="flex flex-wrap gap-1 max-w-[200px]">
                      {asset.tags.slice(0, 3).map(tagName => {
                        ...
                        return (
                          ...
                          >
                            <span
                              className={`w-1.5 h-1.5 rounded-full ${tag?.color || "bg-gray-500"} mr-1`}
                            />
                            {tagName}
                          </Badge>
                        );
