      ...
      <CardContent className="p-4">
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <VerificationBadge
              status={insight.verificationStatus}
              showLabel={false}
            />
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            {insight.citations.map((citation, idx) => {
              ...
              return (
                ...
                >
                  <FileText className="w-3 h-3 mr-1" />[{idx + 1}]{" "}
        ...
        {insight.challenges.length > 0 && (
          <div className="mb-3">
            ...
            >
              ...
              {insight.challenges.length} Chief of Staff Challenge
              {insight.challenges.length > 1 ? "s" : ""}
              {expanded ? (
      ...
      <CardContent>
        ...
        {references.length === 0 && (
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p>
              No references added yet. Add citations to build your reference
              library.
            </p>
          </div>
        )}
...
export function ValidationSummary({
  ...
  const validatedCount = insights.filter(
    ...
    <Card className="bg-card/60 border-border">
      ...
      <CardContent>
        ...
        <div className="mt-4 flex items-center justify-between text-sm">
          ...
          <Badge variant="outline">{insights.length} total insights</Badge>
        </div>
      </CardContent>
    </Card>
  );
