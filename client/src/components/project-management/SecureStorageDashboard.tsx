...
export function SecureStorageDashboard() {
  const [activeTab, setActiveTab] = useState<
    "overview" | "backups" | "security" | "audit"
  >("overview");
  ...
  const storageTiers: StorageTier[] = [
    ...
    },
    {
      ...
      used: 128.5,
      total: 500,
      description: "Older projects, archives",
      color: "bg-amber-500",
    },
    {
      name: "Cold Storage",
      used: 312.8,
      total: 2000,
      description: "Backups, historical data",
      color: "bg-gray-500",
    },
  ];

  const totalUsed = storageTiers.reduce((sum, tier) => sum + tier.used, 0);
  const totalAvailable = storageTiers.reduce(
  ...
  const securityChecks: SecurityCheck[] = [
    ...
    },
    {
      ...
      status: "passed",
      description: "Role-based access configured",
      lastChecked: new Date(),
    },
    {
      id: "5",
      ...
      status: "passed",
      description: "Last backup verified successfully",
      lastChecked: new Date(),
    },
    {
      id: "6",
    ...
    },
    {
      ...
      name: "Data Residency",
      status: "passed",
      description: "Data stored in UK/EU regions",
      lastChecked: new Date(),
    },
    {
      id: "8",
      ...
      status: "warning",
      description: "Some keys older than 90 days",
      lastChecked: new Date(),
    },
  ];
  ...
  const auditLog: AuditLogEntry[] = [
    {
      id: "1",
      action: "File Upload",
      resource: "WasteGen/pitch-deck.pdf",
      user: "Jonathan",
    ...
    },
    {
      ...
      resource: "Sample Project/Final_Report.pdf",
      user: "Jonathan",
      timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000),
      ipAddress: "192.168.1.x",
    },
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-foreground/50">
          Storage usage, backups, and security status
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
            ...
            <p className="text-xs text-red-600 mt-2">
              These actions are irreversible. Use only in case of security
              breach.
            </p>
          </div>
        </div>
