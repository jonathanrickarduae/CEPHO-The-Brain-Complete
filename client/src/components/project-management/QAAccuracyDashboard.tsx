...
export function QAAccuracyDashboard() {
  ...
  const [deliverableMetrics] = useState<DeliverableTypeMetrics[]>(
    SAMPLE_DELIVERABLE_METRICS
  );
  ...
  const getAutonomyBadge = (
    recommendation: QAMetrics["autonomyRecommendation"]
  ) => {
    const badges = {
      not_ready: {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-4 bg-card border border-border rounded-xl">
          ...
          <p className="text-xs text-muted-foreground mt-2">
            {metrics.approvedFirstPass} of {metrics.totalReviews} approved first
            pass
          </p>
        </div>
        ...
        <div className="p-4 bg-card border border-border rounded-xl">
          ...
          <div className="flex items-baseline gap-2">
            <span
              className={`text-3xl font-bold ${getConfidenceColor(metrics.confidenceLevel)}`}
            >
                  ...
                  <tr key={dm.type} className="text-sm">
                    ...
                    <td className="py-3">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <span
                          className={`text-xs font-medium ${getConfidenceColor(dm.confidenceScore)}`}
                        >
                          {dm.confidenceScore}%
                        </span>
                      </div>
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3 p-3 bg-card/50 rounded-lg">
            ...
            <div>
              <p className="text-sm font-medium text-foreground">
                NDA documents ready for limited autonomy
              </p>
              <p className="text-xs text-muted-foreground mt-1">
                With 91.7% approval rate and 85% confidence, the Chief of Staff
                can handle routine NDA reviews with minimal oversight.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-3 bg-card/50 rounded-lg">
            ...
            <div>
              <p className="text-sm font-medium text-foreground">
                Investment Decks need more training
              </p>
              <p className="text-xs text-muted-foreground mt-1">
                At 55% confidence, continue providing detailed feedback on
          ...
          <div className="flex items-start gap-3 p-3 bg-card/50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Lowest confidence at 42%. Provide more examples of vesting terms
                and drag-along provisions you prefer.
              </p>
            </div>
          </div>
        </div>
