...
const MOCK_ACTIVITIES: Activity[] = [
  ...
  },
  {
    id: "2",
    type: "document",
    title: "Updated Q1 financial projections",
  ...
  },
  {
    id: "3",
    type: "research",
    title: "Competitor analysis for pitch deck",
  ...
  },
  {
    id: "4",
    type: "meeting",
    title: "Prepared briefing for board call",
    timestamp: "Yesterday",
    status: "completed",
  },
  {
    id: "5",
    type: "task",
    title: "Reviewing contract amendments",
    timestamp: "Now",
    status: "in_progress",
  },
];
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="flex-1">
          ...
          <p className="font-semibold text-foreground">
            Here's what your Chief of Staff has been working on
          </p>
        </div>
      </div>
