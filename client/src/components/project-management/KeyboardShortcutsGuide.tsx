...
const SHORTCUTS: Shortcut[] = [
  ...
  {
    keys: ["Cmd", "B"],
    description: "Open Daily Brief",
    category: "Dashboard",
  },
  { keys: ["Cmd", "E"], description: "Open AI Experts", category: "Dashboard" },
  {
    keys: ["Cmd", "T"],
    description: "Open Chief of Staff",
    category: "Dashboard",
  },
  ...
  {
    keys: ["Cmd", "Enter"],
    description: "Submit message or form",
    category: "Actions",
  },
  ...
  {
    keys: ["Space"],
    description: "Hold to record (when focused)",
    category: "Voice",
  },
  ...
  {
    keys: ["G", "S"],
    description: "Go to Morning Signal",
    category: "Quick Navigation",
  },
  {
    keys: ["G", "E"],
