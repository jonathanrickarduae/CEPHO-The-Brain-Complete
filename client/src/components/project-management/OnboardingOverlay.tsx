...
const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    description:
      "Your AI Chief of Staff is ready to help. Let's take a quick tour of the key features.",
    target: "body",
    position: "bottom",
    highlight: false,
  },
  {
    ...
    title: "Voice Input",
    description:
      "Click the microphone to record your thoughts. Cepho will transcribe and understand your needs.",
  ...
  },
  {
    ...
    title: "Daily Brief",
    description:
      "Start your day with a personalized briefing of priorities, schedule, and intelligence.",
  ...
  },
  {
    ...
    description:
      "Assemble a team of AI experts for complex projects. Each expert brings unique perspectives.",
  ...
  },
  {
    ...
    description:
      "Define your AI's responsibilities, boundaries, and autonomy levels. Train it to match your style.",
  ...
  },
  {
    ...
    description:
      "You're ready to start. Dismiss this tour anytime by clicking the X button.",
    target: "body",
    position: "bottom",
    highlight: false,
  },
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <Button size="sm" onClick={handleNext} className="text-xs gap-2">
            {isLastStep ? (
              <>
