...
const ENGAGEMENT_TYPES: Array<{
...
}> = [
  {
    ...
    description:
      "Complete new opportunity setup with all documents, models, and architecture",
  ...
  },
  {
    ...
    description:
      "Financial model, valuation analysis, key metrics, and projections",
  ...
  },
  {
    ...
    description:
      "Comprehensive DD checklist, risk assessment, and document requests",
  ...
  },
  {
    ...
    description:
      "NDA, term sheets, shareholder agreements, and corporate documents",
  ...
  },
  {
    ...
    description:
      "Brand building, social media setup, content strategy, and market launch plan",
...
const PROACTIVE_BEST_PRACTICES: BestPracticeItem[] = [
  // Legal
  {
    id: "bp1",
    category: "legal",
    title: "NDA with mutual confidentiality",
    description: "Protect both parties with bilateral NDA terms",
    priority: "critical",
    included: true,
    aiSuggested: true,
  },
  ...
  },
  {
    id: "bp3",
    category: "legal",
    title: "Founder vesting schedules",
    description: "4-year vesting with 1-year cliff is standard",
    priority: "high",
    included: true,
    aiSuggested: true,
  },
  {
    id: "bp4",
    category: "legal",
    title: "Employment contracts review",
    description: "Ensure key employees have proper contracts",
    priority: "high",
    included: false,
    aiSuggested: true,
  },
  ...
  },
  {
    ...
    description: "Discounted cash flow with sensitivity analysis",
    priority: "high",
    included: true,
    aiSuggested: true,
  },
  {
    ...
    description: "Clean cap table with all equity holders",
    priority: "critical",
    included: true,
    aiSuggested: true,
  },
  {
    ...
    description: "CAC, LTV, payback period analysis",
    priority: "high",
    included: false,
    aiSuggested: true,
  },
  ...
  // Operational
  {
    ...
    description: "Clear reporting structure and roles",
    priority: "medium",
    included: true,
    aiSuggested: true,
  },
  {
    id: "bp10",
    category: "operational",
    title: "Key processes documentation",
  ...
  },
  {
    id: "bp11",
    category: "operational",
    title: "Supplier/vendor agreements",
    description: "Review key supplier contracts",
    priority: "high",
    included: false,
    aiSuggested: true,
  },
  ...
  // Brand
  {
    id: "bp12",
    category: "brand",
    title: "Logo quality check",
    description: "Ensure logo is high-res and properly formatted",
    priority: "medium",
    included: true,
    aiSuggested: true,
    rationale:
      "Logo color and format often needs reviewing for professional documents",
  },
  {
    id: "bp13",
    category: "brand",
    title: "Brand guidelines document",
    description: "Colors, fonts, usage rules",
    priority: "low",
    included: false,
    aiSuggested: true,
  },
  {
    ...
    description: "Company name used consistently across all materials",
    priority: "medium",
    included: true,
    aiSuggested: true,
  },
  ...
  // Compliance
  {
    ...
    description: "GDPR/CCPA readiness assessment",
    priority: "high",
    included: true,
    aiSuggested: true,
  },
  ...
  // Governance
  {
    id: "bp18",
    category: "governance",
    title: "Board composition plan",
    description: "Independent directors, observer rights",
    priority: "medium",
    included: false,
    aiSuggested: true,
  },
  {
    ...
    description: "Voting rights, information rights, consent matters",
    priority: "high",
    included: true,
    aiSuggested: true,
  },
  {
    ...
    description: "Clear policy for related party transactions",
    priority: "medium",
    included: false,
    aiSuggested: true,
  },
  ...
  },
  {
    ...
    description: "D&O, E&O, cyber insurance assessment",
    priority: "medium",
    included: false,
    aiSuggested: true,
  },
  {
    ...
    description: "Key person risk and continuity planning",
    priority: "medium",
    included: false,
    aiSuggested: true,
  },
  ...
  // Technical
  {
    ...
    description: "Scalability and technical debt assessment",
    priority: "medium",
    included: false,
    aiSuggested: true,
  },
...
export function ProjectGenesis() {
  ...
  const toggleBestPractice = (id: string) => {
    setBestPractices(prev =>
      prev.map(bp => (bp.id === id ? { ...bp, included: !bp.included } : bp))
    );
  };
  ...
  const generateDeliverables = (
    ...
    if (type === "full_genesis") {
      base.push(
        {
          id: "qms",
          name: "Quality Management Framework",
          type: "document",
          category: "Governance",
          status: "pending",
          estimatedTime: "15 mins",
    ...
    if (type === "go_to_market") {
      base.push(
        ...
        {
          id: "platform_setup",
          name: "Platform Optimization Guide",
          type: "checklist",
          category: "Social",
          status: "pending",
          estimatedTime: "20 mins",
        ...
        {
          id: "bio_copy",
          name: "Bio & Profile Copy (All Platforms)",
          type: "document",
          category: "Social",
          status: "pending",
          estimatedTime: "15 mins",
        ...
        {
          id: "influencer_list",
          name: "Influencer & Partner Targets",
          type: "checklist",
          category: "Growth",
          status: "pending",
          estimatedTime: "15 mins",
        ...
        {
          id: "kpi_dashboard",
          name: "KPI & Analytics Dashboard Setup",
          type: "checklist",
          category: "Analytics",
          status: "pending",
          estimatedTime: "15 mins",
        ...
        {
          id: "automation",
          name: "Posting & Automation Setup Guide",
          type: "checklist",
          category: "Operations",
          status: "pending",
          estimatedTime: "15 mins",
  ...
  const startGeneration = async () => {
    ...
    for (let i = 0; i < deliverables.length; i++) {
      ...
      setDeliverables(prev =>
        prev.map((d, idx) => (idx === i ? { ...d, status: "generating" } : d))
      );
          ...
          idx === i
            ? {
                ...
                qaStatus: {
                  ...
                  twinNotes:
                    Math.random() > 0.5
                      ? "Looks good, minor formatting suggestions applied."
                      : "Reviewed and approved. All sections complete.",
                },
              }
            : d
        )
            ...
            <label className="flex items-center gap-3 p-4 rounded-lg border border-border bg-card cursor-pointer hover:border-primary/50">
              <input
                ...
                onChange={e =>
                  setScopingAnswers(prev => ({
                    ...prev,
                    existingMaterials: e.target.checked,
                  }))
                }
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Prior documents, models, or presentations
                </p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3 p-4 rounded-lg border border-border bg-card cursor-pointer hover:border-primary/50">
              <input
                ...
                onChange={e =>
                  setScopingAnswers(prev => ({
                    ...prev,
                    counterpartyInvolved: e.target.checked,
                  }))
                }
                className="w-4 h-4 rounded border-border"
              />
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Investor, partner, or acquirer identified
                </p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3 p-4 rounded-lg border border-border bg-card cursor-pointer hover:border-primary/50">
              <input
                ...
                onChange={e =>
                  setScopingAnswers(prev => ({
                    ...prev,
                    regulatoryConsiderations: e.target.checked,
                  }))
                }
                className="w-4 h-4 rounded border-border"
              />
            ...
            <label className="flex items-center gap-3 p-4 rounded-lg border border-border bg-card cursor-pointer hover:border-primary/50">
              <input
                ...
                onChange={e =>
                  setScopingAnswers(prev => ({
                    ...prev,
                    crossBorderElements: e.target.checked,
                  }))
                }
                className="w-4 h-4 rounded border-border"
              />
            ...
            <div className="flex gap-3">
              {(["standard", "urgent", "critical"] as const).map(urgency => (
                <button
                  key={urgency}
                  onClick={() =>
                    setScopingAnswers(prev => ({ ...prev, urgency }))
                  }
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-foreground flex items-center gap-2">
              ...
              <span className="text-xs font-normal text-muted-foreground ml-2">
                (We've identified{" "}
                {bestPractices.filter(bp => bp.aiSuggested).length} items you
                should consider)
              </span>
            </h3>
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
            <p className="text-sm text-amber-200">
              <strong>Proactive Analysis:</strong> Based on your engagement
              type, we've identified best practices from legal, financial,
              operational, brand, compliance, governance, risk, and technical
              perspectives. Toggle items to include or exclude from your
              deliverables.
            </p>
          </div>
          ...
          <div className="space-y-2">
            {(
              ...
              const categoryItems = bestPractices.filter(
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <span className="text-amber-500">
            {deliverables.filter(d => d.status === "qa_review").length} pending
            review
          </span>
          <span className="text-red-500">
            {deliverables.filter(d => d.status === "revision_needed").length}{" "}
            needs revision
          </span>
        </div>
      </div>
      ...
      <div className="bg-primary/10 border border-blue-500/30 rounded-lg p-4">
        <p className="text-sm text-blue-200">
          ...
          revisions. Your feedback trains the Twin to improve future quality
          assessments.
        </p>
      </div>
            ...
            {d.status === "qa_review" && (
              <div className="mt-4 space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <button
                    onClick={() =>
                      handleQAAction(d.id, "approve", qaFeedback[d.id])
                    }
                  ...
                  <button
                    onClick={() =>
                      handleQAAction(d.id, "revise", qaFeedback[d.id])
                    }
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground mt-2">
          AI Experts are creating your documents. Chief of Staff will review
          each one.
        </p>
      </div>
  ...
  const renderComplete = () => (
    <div className="text-center space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          All {deliverables.length} deliverables have been generated and
          approved.
        </p>
      </div>
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          New opportunity engine with AI-powered document generation, visual
          blueprints, and quality assurance
        </p>
      </div>
            ...
            return (
              <React.Fragment key={s}>
                <div className="flex flex-col items-center">
                  ...
                  <span
                    className={`text-xs mt-1 ${isCurrent ? "text-primary font-medium" : "text-muted-foreground"}`}
                  >
                    {labels[s]}
                  </span>
                </div>
