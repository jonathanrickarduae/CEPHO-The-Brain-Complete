...
const mockActions: ActionItem[] = [
  {
    id: "1",
    title: "Complete CEO KPI Report",
    description: "Generate monthly scorecard with all 75 categories",
    status: "completed",
    priority: "high",
    category: "Executive",
    progress: 100,
  ...
  {
    id: "2",
    title: "Wire NPS Survey to Dashboard",
    description: "Connect NPS component to user touchpoints",
    status: "completed",
    priority: "high",
    category: "Operations",
    progress: 100,
  ...
  {
    id: "3",
    title: "Implement COS Learning System",
    description: "Build pattern analysis and preference modeling",
    status: "in_progress",
    priority: "high",
    category: "Technology",
    progress: 75,
  },
  {
    ...
    description: "CEPHO branded templates for all report types",
    status: "in_progress",
    priority: "medium",
    category: "Content",
    progress: 85,
  ...
  {
    id: "5",
    title: "Claim Stripe Sandbox",
    description: "Activate payment processing for subscriptions",
    status: "pending",
    priority: "high",
    category: "Finance",
    dueDate: "Mar 18, 2026",
  },
  {
    ...
    description: "Connect ElevenLabs to Morning Signal",
    status: "pending",
    priority: "medium",
    category: "Technology",
  },
  {
    ...
    description: "Launch content calendar and social strategy",
    status: "pending",
    priority: "medium",
    category: "Growth",
  },
  {
    ...
    description: "Schedule and conduct 10 customer interviews",
    status: "blocked",
    priority: "high",
    category: "Growth",
    dueDate: "Jan 25, 2026",
...
export function ActionStatusDashboard() {
  const [filter, setFilter] = useState<
    "all" | "in_progress" | "pending" | "blocked"
  >("all");

  const totalActions = mockActions.length;
  const completedActions = mockActions.filter(
    a => a.status === "completed"
  ).length;
  const inProgressActions = mockActions.filter(
