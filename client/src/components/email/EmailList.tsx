    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2 flex-wrap">
        <Button
          ...
          className={
            selectedCategory === null ? "bg-purple-600" : "border-gray-700"
          }
        >
          All
        </Button>
        {["work", "personal", "finance", "social", "promotions"].map(
          category => (
            <Button
              key={category}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <div className="flex gap-1">
                        {email.priority && (
                          <Badge
                            className={`${getPriorityColor(email.priority)} text-xs`}
                          >
                            {email.priority}
                          </Badge>
                        )}
                        {email.category && (
                          <Badge
                            className={`${getCategoryColor(email.category)} text-xs`}
                          >
                            {email.category}
                          </Badge>
                        )}
                    ...
                    {email.actionItems && email.actionItems.length > 0 && (
                      <div className="flex gap-1 mt-2">
                        ...
                        <span className="text-xs text-yellow-500">
                          {email.actionItems.length} action item
                          {email.actionItems.length > 1 ? "s" : ""}
                        </span>
                      </div>
                    )}
                  </div>
