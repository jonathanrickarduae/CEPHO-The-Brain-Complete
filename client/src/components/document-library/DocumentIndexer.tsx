...
const MOCK_DOCUMENTS: IndexedDocument[] = [
  {
    ...
    chunks: 45,
    preview:
      "Project A represents a compelling investment opportunity in the sustainable energy sector...",
  },
  {
    id: "d2",
  ...
  },
  {
    ...
    chunks: 12,
    preview:
      "Non-disclosure agreement between parties regarding confidential information...",
  },
  {
    id: "d4",
    ...
    chunks: 67,
    preview:
      "AI-generated market analysis covering competitive landscape, market size, and growth projections...",
  },
  {
    id: "d5",
    ...
    chunks: 34,
    preview:
      "Q3 board presentation covering strategic initiatives, financial performance, and roadmap...",
  },
];
          ...
          {isIndexing && (
            <div className="mb-4">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Processing documents... {indexProgress}%
              </p>
            </div>
          )}
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-8 h-8 rounded flex items-center justify-center ${getTypeColor(result.document.type)}`}
                        >
          ...
          {filteredDocuments.map(doc => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`w-10 h-10 rounded-lg flex items-center justify-center ${getTypeColor(doc.type)}`}
                  >
