...
import { FileText, Copy, Check, Info, Calendar, Tag, Hash } from "lucide-react";
...
const documentTypes = [
  { value: "MEMO", label: "Memo", description: "Internal memorandum" },
  {
    value: "REPORT",
    label: "Report",
    description: "Analysis or findings report",
  },
  ...
  { value: "PLAN", label: "Plan", description: "Strategic or project plan" },
  {
    value: "ANALYSIS",
    label: "Analysis",
    description: "Data or market analysis",
  },
  ...
  { value: "TEMPLATE", label: "Template", description: "Reusable template" },
  {
    value: "CHECKLIST",
    label: "Checklist",
    description: "Task or process checklist",
  },
];
        ...
        <CardContent className="py-4">
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              className="bg-[#E91E8C] hover:bg-[#E91E8C]/80"
            >
              {copied ? (
