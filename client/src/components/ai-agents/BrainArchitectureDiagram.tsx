...
const ARCHITECTURE_NODES: ArchitectureNode[] = [
  {
    ...
    name: "Core AI",
    description:
      "Central intelligence engine that orchestrates all AI operations",
    icon: Brain,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Interactive system diagram - tap nodes to explore
              </p>
            </div>
          </div>
        </CardContent>
          ...
          <div className="relative min-h-[400px]">
            ...
            >
              ...
              <line
                ...
                y2="20%"
                stroke={
                  isConnected("analytics") && isConnected("insights")
                    ? "#6366F1"
                    : "#374151"
                }
                strokeWidth="1"
              ...
              <line
                ...
                y2="80%"
                stroke={
                  isConnected("insights") && isConnected("wellness")
                    ? "#14B8A6"
                    : "#374151"
                }
                strokeWidth="1"
            ...
            <div
              ...
              onClick={() =>
                setSelectedNode(
                  ARCHITECTURE_NODES.find(n => n.id === "core") || null
                )
              }
            >
              <div
                className={`w-24 h-24 rounded-full ${ARCHITECTURE_NODES[0].bgColor} border-2 border-purple-500/50 flex flex-col items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110 ${hoveredNode === "core" ? "ring-4 ring-purple-500/30" : ""}`}
              >
            ...
            <div
              ...
              onClick={() =>
                setSelectedNode(
                  ARCHITECTURE_NODES.find(n => n.id === "analytics") || null
                )
              }
            >
              <div
            ...
            <div
              ...
              onClick={() =>
                setSelectedNode(
                  ARCHITECTURE_NODES.find(n => n.id === "insights") || null
                )
              }
            >
              <div
                className={`w-20 h-20 rounded-full ${ARCHITECTURE_NODES[2].bgColor} border-2 border-green-500/50 flex flex-col items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110 ${hoveredNode === "insights" || isConnected("insights") ? "ring-4 ring-green-500/30" : "opacity-70"}`}
              >
                <Users className="w-6 h-6 text-green-400" />
                <span className="text-xs font-medium text-green-400 mt-1">
                  Insights
                </span>
              </div>
            </div>
            ...
            <div
              ...
              onClick={() =>
                setSelectedNode(
                  ARCHITECTURE_NODES.find(n => n.id === "wellness") || null
                )
              }
            >
              <div
                className={`w-20 h-20 rounded-full ${ARCHITECTURE_NODES[3].bgColor} border-2 border-pink-500/50 flex flex-col items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110 ${hoveredNode === "wellness" || isConnected("wellness") ? "ring-4 ring-pink-500/30" : "opacity-70"}`}
              >
                <Heart className="w-6 h-6 text-[oklch(0.72_0.19_45)]" />
                <span className="text-xs font-medium text-[oklch(0.72_0.19_45)] mt-1">
                  Wellness
                </span>
              </div>
            </div>
            ...
            <div
              ...
              onClick={() =>
                setSelectedNode(
                  ARCHITECTURE_NODES.find(n => n.id === "experts") || null
                )
              }
            >
              <div
                className={`w-20 h-20 rounded-full ${ARCHITECTURE_NODES[4].bgColor} border-2 border-yellow-500/50 flex flex-col items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110 ${hoveredNode === "experts" || isConnected("experts") ? "ring-4 ring-yellow-500/30" : "opacity-70"}`}
              >
        ...
        <Card className="bg-card/60 border-border">
          <CardContent className="p-4">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 rounded-lg ${selectedNode.bgColor} flex items-center justify-center`}
                >
                  <selectedNode.icon
                    className={`w-5 h-5 ${selectedNode.color}`}
                  />
                </div>
                <div>
        ...
        <CardContent className="p-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {ARCHITECTURE_NODES.map(node => (
              ...
              >
                <div
                  className={`w-6 h-6 rounded ${node.bgColor} flex items-center justify-center`}
                >
