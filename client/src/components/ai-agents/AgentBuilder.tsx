    ...
    actions: [
      {
        ...
        description: "Research attendees and topics",
        config: {},
      },
    ],
  },
    ...
    actions: [
      {
        ...
        type: "message",
        name: "Send reminder",
        description: "Notify about pending tasks",
        config: {},
      },
    ],
  },
  ...
  const [pendingActions, setPendingActions] = useState<PendingAction[]>([
    {
      ...
      preview:
        "Thank you for your email. I've reviewed the proposal and have a few questions...",
      createdAt: new Date(),
      status: "pending",
    },
  ]);

  const [activeTab, setActiveTab] = useState<"agents" | "queue" | "templates">(
    "agents"
  );
      ...
      <div className="flex border-b border-white/10">
        {[
          { id: "agents", label: "My Agents", count: agents.length },
          {
            ...
            count: pendingActions.filter(a => a.status === "pending").length,
          },
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={cn(
                          ...
                          getAutonomyColor(agent.autonomyLevel)
                        )}
                      >
                        {agent.autonomyLevel}
                      </span>
        ...
        {activeTab === "templates" && (
          <div className="grid gap-3">
            ...
            <div
              ...
              onClick={() =>
                createAgentFromTemplate({ name: "Custom Agent", icon: "🤖" })
              }
            >
