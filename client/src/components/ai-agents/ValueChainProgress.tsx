  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="space-y-2">
            {valueChainPhases.map((phase, _index) => {
              ...
              const checkProgress =
                phase.qualityGateChecks.length > 0
                  ? Math.round(
                      (completedChecks.length /
                        phase.qualityGateChecks.length) *
                        100
                    )
                  : 0;
              ...
              return (
                <div key={phase.id} className="relative">
                  ...
                  >
                    ...
                    <ChevronRight
                      className={`w-5 h-5 text-foreground/70 transition-transform ${isExpanded ? "rotate-90" : ""}`}
                    />
                  </div>
                      ...
                      <div className="mb-4">
                        ...
                        <ul className="space-y-1">
                          {phase.objectives.map((obj, i) => (
                            ...
                            >
                              <span
                                className={`w-1.5 h-1.5 rounded-full ${phase.bgColor} mt-1.5 shrink-0`}
                              />
                              {obj}
                            </li>
                          ))}
      ...
      <div className="p-4 border-t border-white/10 bg-white/5">
        <h4 className="text-xs font-semibold text-foreground/70 uppercase tracking-wider mb-3">
          Quality Gate Levels
        </h4>
