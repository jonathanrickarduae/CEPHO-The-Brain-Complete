...
const MOCK_EPISODES: PodcastEpisode[] = [
  {
    ...
    matchScore: 98,
    description:
      "Deep dive into how AI is transforming business operations and decision-making.",
  },
  {
    id: "2",
    ...
    matchScore: 94,
    description:
      "Strategies for creating and managing teams that deliver exceptional results.",
  },
  {
    id: "3",
    ...
    matchScore: 91,
    description:
      "Expert analysis on market trends and investment opportunities.",
  },
  {
    id: "4",
    ...
    matchScore: 87,
    description:
      "How mindfulness practices can enhance your leadership effectiveness.",
  },
];
...
export function AIPodcastHub() {
  const [activeTab, setActiveTab] = useState<
    "discover" | "foryou" | "create" | "library"
  >("discover");
  const [category, setCategory] = useState<Category>("all");
  const [searchQuery, setSearchQuery] = useState("");
  const [playingId, setPlayingId] = useState<string | null>(null);

  const filteredEpisodes = MOCK_EPISODES.filter(
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Curated podcasts & AI-generated audio content tailored to your
            interests
          </p>
        </div>
      </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="px-2 py-0.5 bg-secondary/50 rounded text-xs capitalize">
                    {episode.category}
                  </span>
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <span className="text-sm font-medium text-amber-500">
                    {episode.matchScore}% match
                  </span>
                </div>
              </div>

              {/* Play Button */}
              <Button size="sm" onClick={() => togglePlay(episode.id)}>
                {playingId === episode.id ? (
                  <>
