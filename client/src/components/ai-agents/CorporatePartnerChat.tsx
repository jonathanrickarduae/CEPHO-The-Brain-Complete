...
export function CorporatePartnerChat({
  partnerId,
  onClose,
}: CorporatePartnerChatProps) {
  ...
  const generatePartnerResponse = (
    ...
    if (partner.name === "NASA") {
      ...
      if (
        ...
        lowerMessage.includes("moonshot")
      ) {
    ...
    if (partner.name === "Tesla") {
      if (
        lowerMessage.includes("first principles") ||
  ...
  const sendMessage = () => {
    ...
    const _systemPromptParts = [
      ...
      partner.thinkingFramework
        ? `Your thinking framework: ${partner.thinkingFramework}`
        : "",
      partner.researchApproach
        ? `Your research approach: ${partner.researchApproach}`
        : "",
      partner.keyPrinciples
        ? `Your key principles: ${partner.keyPrinciples.join(", ")}`
        : "",
      partner.signatureTools
        ? `Your signature tools and frameworks: ${partner.signatureTools.join(", ")}`
        : "",
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground italic">
                    "
                    {partner.thinkingFramework?.split(".")[0] ||
                      partner.methodology}
                    "
                  </p>
                </div>
