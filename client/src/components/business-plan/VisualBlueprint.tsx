  ...
  layers: [
    {
      ...
      color: "#8B5CF6",
      nodes: ["gov1", "gov2", "gov3"],
    },
    {
      id: "legal",
      name: "Legal Structure",
      color: "#3B82F6",
      nodes: ["legal1", "legal2", "legal3", "legal4"],
    },
    {
      id: "financial",
      name: "Financial Architecture",
      color: "#10B981",
      nodes: ["fin1", "fin2", "fin3", "fin4"],
    },
    {
      id: "operational",
      name: "Operational Framework",
      color: "#F59E0B",
      nodes: ["ops1", "ops2", "ops3"],
    },
    {
      id: "risk",
      name: "Risk Management",
      color: "#EF4444",
      nodes: ["risk1", "risk2", "risk3"],
    },
  ],
  nodes: [
    // Governance Layer
    {
      ...
      description: "Independent directors, committees",
      status: "pending",
      position: { x: 100, y: 80 },
      category: "governance",
    },
    {
      ...
      description: "Rights, obligations, transfers",
      status: "in_progress",
      connections: ["gov1"],
      position: { x: 300, y: 80 },
      category: "governance",
    },
    {
      ...
      description: "Voting, consent matters",
      status: "pending",
      connections: ["gov1", "gov2"],
      position: { x: 500, y: 80 },
      category: "governance",
    },
    ...
    },
    {
      ...
      description: "Corporate constitution",
      status: "in_progress",
      connections: ["legal1"],
    ...
    },
    {
      ...
      description: "Key personnel agreements",
      status: "pending",
      connections: ["legal2"],
    ...
    // Financial Layer
    {
      ...
      description: "3-statement projections",
      status: "in_progress",
    ...
    },
    {
      ...
      type: "document",
      label: "Cap Table",
      description: "Equity ownership structure",
      status: "pending",
      connections: ["fin1", "gov2"],
    ...
    },
    {
      ...
      type: "process",
      label: "Key Processes",
      description: "Sales, delivery, support",
      status: "pending",
      connections: ["ops1"],
    ...
    // Risk Layer
    {
      ...
      type: "risk",
      label: "Market Risk",
      description: "Competition, demand",
      status: "pending",
    ...
    },
    {
      ...
      description: "Key person, continuity",
      status: "pending",
      connections: ["risk1", "ops1"],
...
export function VisualBlueprint({
  ...
  const blueprint = data?.nodes
    ? (data as BlueprintData)
    : {
        ...SAMPLE_BLUEPRINT,
  ...
  const getStatusIcon = (status?: BlueprintNode["status"]) => {
    switch (status) {
      ...
      default:
        return <Clock className="w-3 h-3 text-foreground/60" />;
    }
  };
  ...
  return (
    <div className="bg-card border border-border rounded-xl overflow-hidden">
      ...
      <div className="flex">
        ...
        {/* Blueprint Canvas */}
        <div
          className="flex-1 overflow-auto bg-background/50 p-4"
        ...
        >
          ...
          >
            ...
            {blueprint.nodes.map(node => {
              const layer = blueprint.layers.find(l =>
              ...
              return (
                ...
                >
                  <div
                    className={`px-3 py-2 rounded-lg border-2 bg-card shadow-lg min-w-[120px] ${getStatusColor(
                      node.status
      ...
      <div className="flex items-center justify-between p-3 border-t border-border bg-secondary/20 text-xs text-muted-foreground">
        <div className="flex items-center gap-4">
          ...
          <span>
            {blueprint.nodes.filter(n => n.status === "complete").length}{" "}
            complete
          </span>
        </div>
        <div className="flex items-center gap-2">
