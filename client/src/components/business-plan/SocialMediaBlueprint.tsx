...
import {
  ...
  type PlatformIntelligence,
  type PostingWindow,
} from "@/data/platform-intelligence.data";
...
export function SocialMediaBlueprint() {
  ...
  const [contentQueue] = useState<ContentItem[]>([
    {
      ...
      description: "Quick 30s tour of our new facility",
      status: "scheduled",
    ...
    },
    {
      ...
      type: "carousel",
      platform: "instagram",
      title: "5 Tips for Entrepreneurs",
      description: "Educational carousel with actionable tips",
      status: "draft",
    },
    {
      id: "3",
      type: "video",
      platform: "youtube",
      title: "Deep Dive: Market Analysis 2024",
      description: "15-minute analysis video",
      status: "generating",
    },
    {
      id: "4",
    ...
    },
    {
      ...
      type: "short",
      platform: "youtube",
      title: "Quick Tip: Productivity Hack",
  ...
  const getPlatformIntel = (
    platformId: string
  ): PlatformIntelligence | undefined => {
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {intel.optimalPostingTimes.map(
                            (window: PostingWindow, i: number) => (
                              <Badge
                                key={i}
                                variant="outline"
                        ...
                        <div className="flex flex-wrap gap-2">
                          {intel.contentFormats.map((format, i: number) => (
                            <Badge
                              key={i}
                              variant="outline"
                              className="bg-[oklch(0.72_0.19_45/0.08)] text-[oklch(0.72_0.19_45)] border-pink-500/30"
                            >
                              {format.type}
                            </Badge>
                          ))}
          ...
          <div className="space-y-3">
            {contentQueue.map(item => {
              ...
              return (
                <div
                  key={item.id}
                  className="p-4 bg-card/50 rounded-xl border border-white/10 flex items-center gap-4"
                >
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className={`w-8 h-8 rounded-lg bg-gradient-to-br ${platform?.color || "from-gray-500 to-gray-600"} flex items-center justify-center`}
                    >
      ...
      {activeTab === "schedule" && (
        <div className="p-8 bg-card/50 rounded-xl border border-white/10 text-center">
          ...
          <p className="text-muted-foreground mb-4">
            Visual calendar view with drag-and-drop scheduling not yet
            implemented.
            <br />
            Optimal posting times are automatically suggested based on platform
            intelligence.
          </p>
