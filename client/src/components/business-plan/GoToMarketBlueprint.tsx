    ...
    tasks: [
      {
        ...
        description: "Calculate the total market size",
        completed: false,
      },
      {
        id: "m2",
        title: "Serviceable Addressable Market (SAM)",
        description: "Define the segment you can reach",
        completed: false,
      },
      {
        id: "m3",
        title: "Serviceable Obtainable Market (SOM)",
        description: "Realistic market share target",
        completed: false,
      },
      {
        id: "m4",
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        description: "How you want to be perceived",
        completed: false,
      },
      {
        id: "p3",
        title: "Key Messages",
        description: "Core messages for each persona",
        completed: false,
      },
      {
        id: "p4",
    ...
    tasks: [
      {
        ...
        description: "List all potential channels",
        completed: false,
      },
      {
        id: "c2",
        title: "Channel Prioritization",
        description: "Rank by potential ROI",
        completed: false,
      },
      {
        id: "c3",
      ...
      },
      {
        ...
        description: "Online acquisition channels",
        completed: false,
      },
    ],
  },
    ...
    tasks: [
      {
        id: "pr1",
        title: "Pricing Model",
        description: "Subscription, usage, one-time, etc.",
        completed: false,
      },
      {
        id: "pr2",
        title: "Price Points",
        description: "Specific pricing tiers",
        completed: false,
      },
      {
        id: "pr3",
        title: "Packaging",
        description: "Feature bundles per tier",
        completed: false,
      },
      {
        id: "pr4",
      ...
      },
      {
        ...
        description: "When and how to discount",
        completed: false,
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        description: "Where to announce",
        completed: false,
      },
      {
        id: "l3",
        title: "PR Strategy",
        description: "Media and press plan",
        completed: false,
      },
      {
        id: "l4",
      ...
      },
      {
        ...
        description: "How to measure launch success",
        completed: false,
      },
    ],
  },
    ...
    tasks: [
      {
        ...
        description: "Process and best practices",
        completed: false,
      },
      {
        id: "s2",
      ...
      },
      {
        id: "s3",
        title: "Demo Script",
        description: "Product demonstration flow",
        completed: false,
      },
      {
        id: "s4",
      ...
      phases.map(phase => {
        if (phase.id === phaseId) {
          return {
            ...
            tasks: phase.tasks.map(task =>
              task.id === taskId
                ? { ...task, output: taskOutput, completed: true }
                : task
            ),
          };
        }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="mt-1">
                {projectName
                  ? `Building GTM strategy for ${projectName}`
                  : "Build your comprehensive go-to-market strategy"}
              </CardDescription>
            </div>
            <Button
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground">
                Ask your AI SMEs for guidance on any section
              </p>
            </div>
