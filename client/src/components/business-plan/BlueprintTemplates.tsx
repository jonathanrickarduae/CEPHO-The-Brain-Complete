...
> = {
  ...
  archived: {
    label: "Archived",
    color: "text-foreground/60 bg-gray-600/20",
...
export const defaultTemplates: BlueprintTemplate[] = [
  // Phase 1: Ideation
  {
    ...
    description:
      "Document initial idea with problem statement and proposed solution",
    phase: "ideation",
    sections: [
      {
        id: "s1",
      ...
      },
      {
        ...
        description: "What assumptions are we making?",
        required: true,
        completed: false,
      },
      {
    ...
    sections: [
      {
        ...
        description: "What does the market data tell us?",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Who else is solving this?",
        required: true,
        completed: false,
      },
      {
  ...
  // Phase 2: Innovation
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: "Unique value we deliver",
        required: true,
        completed: false,
      },
      {
        ...
        description: "3-5 year financial model",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Team, budget, timeline",
        required: true,
        completed: false,
      },
      {
        ...
        description: "How we address key risks",
        required: true,
        completed: false,
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: "Why would each failure occur?",
        required: true,
        completed: false,
      },
      {
        ...
        description: "How do we prevent failures?",
        required: true,
        completed: false,
      },
      {
        ...
        description: "What if prevention fails?",
        required: true,
        completed: false,
      },
      {
  ...
  // Phase 3: Development
  {
    ...
    sections: [
      ...
      },
      {
        id: "s3",
        title: "Data Model",
        description: "Database schema and data flows",
        required: true,
        completed: false,
      },
      {
      ...
      },
      {
        ...
        description: "Test plan and coverage",
        required: true,
        completed: false,
      },
    ],
    ...
    sections: [
      {
        id: "s1",
        title: "Sprint Goals",
        description: "What will we achieve?",
        required: true,
        completed: false,
      },
      {
      ...
      },
      {
        ...
        description: "Individual tasks and estimates",
        required: true,
        completed: false,
      },
      {
  ...
  // Phase 4: Go-to-Market
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: "Initial customer segments",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Key messages and value props",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Marketing and sales channels",
        required: true,
        completed: false,
      },
      {
      ...
      },
      {
        ...
        description: "Launch risk mitigation",
        required: true,
        completed: false,
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        id: "s2",
        title: "Sales Process",
        description: "Step-by-step sales flow",
        required: true,
        completed: false,
      },
      {
      ...
      },
      {
        ...
        description: "How to win against competitors",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Pricing strategy and tiers",
        required: true,
        completed: false,
      },
    ],
    ...
    sections: [
      {
        ...
        description: "Routine tasks and checks",
        required: true,
        completed: false,
      },
      {
        ...
        description: "How to handle issues",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Who to contact when",
        required: true,
        completed: false,
      },
      {
      ...
      },
      {
        ...
        description: "What to monitor and alert on",
        required: true,
        completed: false,
      },
    ],
    ...
    sections: [
      {
        ...
        description: "How to measure customer health",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Touchpoint strategy",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Upsell and cross-sell paths",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Early warning signs and interventions",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Renewal timeline and approach",
        required: true,
        completed: false,
      },
    ],
    ...
    sections: [
      {
        ...
        description: "M&A, IPO, or other paths",
        required: true,
        completed: false,
      },
      {
        ...
        description: "Current and target valuation",
        required: true,
        completed: false,
      },
      {
      ...
      },
      {
        ...
        description: "Exit preparation roadmap",
        required: true,
        completed: false,
      },
    ],
    ...
    <div className="border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition-colors">
      ...
      >
        <div className="flex items-start justify-between">
          ...
          <ChevronRight
            className={`w-5 h-5 text-foreground/70 transition-transform ${expanded ? "rotate-90" : ""}`}
          />
        </div>
      </div>
          ...
          <div>
            ...
            <div className="space-y-1">
              {template.sections.map(section => (
                ...
                >
                  <div
                    className={`w-2 h-2 rounded-full ${section.required ? "bg-cyan-400" : "bg-gray-500"}`}
                  />
            ...
            <div className="flex flex-wrap gap-1">
              {template.requiredExperts.map(expert => (
                <Badge
                  key={expert}
                  variant="outline"
                  className="text-xs border-white/20 text-foreground/80"
                >
                  {expert}
                </Badge>
              ))}
...
export function BlueprintTemplatesDashboard({
  ...
  const [selectedPhase, setSelectedPhase] = useState<ValueChainPhase | "all">(
    "all"
  );
  const [searchQuery, setSearchQuery] = useState("");
  const [showCreateModal, setShowCreateModal] = useState(false);
  const [selectedTemplate, setSelectedTemplate] =
    useState<BlueprintTemplate | null>(null);

  const filteredTemplates = defaultTemplates.filter(template => {
    if (selectedPhase !== "all" && template.phase !== selectedPhase)
      return false;
    if (
      searchQuery &&
  ...
  const handleCreateBlueprint = () => {
    if (selectedTemplate && onCreateBlueprint) {
      ...
      toast.success(
        `Blueprint created from "${selectedTemplate.name}" template`
      );
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <select
          value={selectedPhase}
          onChange={e =>
            setSelectedPhase(e.target.value as ValueChainPhase | "all")
          }
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-background rounded-xl border border-white/10 max-w-lg w-full p-6">
            ...
            <p className="text-foreground/70 mb-4">
              Create a new blueprint from the "{selectedTemplate.name}"
              template.
            </p>
