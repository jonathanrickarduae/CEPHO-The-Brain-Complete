...
const slideTypes: {
...
}[] = [
  {
    ...
    description: "Company name, tagline, presenter",
  },
  {
    type: "problem",
    label: "Problem",
  ...
  },
  {
    ...
    label: "Product",
    icon: Rocket,
    description: "Demo, features, screenshots",
  },
  {
    type: "traction",
    label: "Traction",
    icon: BarChart3,
    description: "Metrics, growth, milestones",
  },
  {
    type: "business_model",
    label: "Business Model",
    icon: DollarSign,
    description: "Revenue streams, pricing",
  },
  {
    type: "competition",
    label: "Competition",
    icon: Target,
    description: "Competitive landscape, moat",
  },
  {
    type: "team",
    label: "Team",
    icon: Users,
    description: "Founders, key hires, advisors",
  },
  {
    type: "financials",
    label: "Financials",
    icon: BarChart3,
    description: "Projections, unit economics",
  },
  {
    type: "ask",
    label: "The Ask",
    icon: Building2,
    description: "Funding amount, use of funds",
  },
  {
    type: "appendix",
    label: "Appendix",
...
const _genesisData = {
  ...
  problem:
    "Business leaders are overwhelmed by fragmented tools, disconnected data, and the cognitive load of managing multiple AI assistants.",
  solution:
    "A unified AI ecosystem that learns your patterns, manages your digital life, and proactively surfaces insights and opportunities.",
  market: {
    tam: "$50B",
    sam: "$12B",
    som: "$500M",
...
const availableProjects = [
  {
    ...
    description: "AI command center platform",
    lastUpdated: "2 days ago",
  },
  {
    id: "short-circle-navigator",
    name: "Short Circle Navigator",
    description: "Investment navigation tool",
    lastUpdated: "1 week ago",
  },
  {
    id: "celadon",
    name: "Project A",
    description: "Sustainable technology venture",
    lastUpdated: "3 days ago",
  },
  {
    id: "project-genesis",
    name: "Project Genesis",
    description: "Innovation incubator",
...
export function PresentationBlueprint() {
  const [startMode, setStartMode] = useState<
    "select" | "quick" | "project" | null
  >(null);
  const [selectedProject, setSelectedProject] = useState<string | null>(null);
  const [uploadedFiles, setUploadedFiles] = useState<File[]>([]);
  const [currentStep, setCurrentStep] = useState<
    "structure" | "content" | "design" | "review"
  >("structure");
    ...
    setSlides(prev =>
      prev.map((s, i) =>
        i === slideIndex
          ? {
              ...s,
              aiSuggestions: s.aiSuggestions.filter(sug => sug !== suggestion),
            }
          : s
      )
    );
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Start fresh, upload documents
                </p>
              </div>
            </div>
            <p className="text-sm text-muted-foreground mb-4">
              Jump straight in and create a presentation from scratch. Upload
              your own documents, data, and research.
            </p>
          ...
          <div className="p-6 bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-2 border-blue-500/30 rounded-2xl">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Connect to an existing project and automatically pull research,
              data, and documents from your Library.
            </p>
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <label htmlFor="presentation-file-upload" className="cursor-pointer">
            ...
            <p className="text-sm text-muted-foreground">
              PDFs, Word docs, PowerPoints, spreadsheets - we'll extract the key
              information
            </p>
          </label>
        </div>
      ...
      {currentStep === "structure" && (
        <div className="space-y-6">
          <div className="p-4 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-xl border border-blue-500/20">
            ...
            <p className="text-sm text-muted-foreground">
              Company info, value proposition, market analysis, and team data
              will be automatically populated from your Genesis Blueprint.
            </p>
          </div>
          ...
          <div className="col-span-2 space-y-4">
            <div className="p-6 bg-card/50 rounded-xl border border-white/10">
              ...
              <Textarea
                ...
                onChange={e =>
                  updateSlideContent(activeSlide, "content", e.target.value)
                }
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={e =>
                    updateSlideContent(activeSlide, "notes", e.target.value)
                  }
        ...
        <div className="space-y-6">
          <div className="p-6 bg-card/50 rounded-xl border border-white/10">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-foreground">
                Theme:{" "}
                <strong>
                  {designThemes.find(t => t.id === selectedTheme)?.name}
                </strong>
              </span>
            </div>
          ...
          <div className="p-4 bg-gradient-to-r from-amber-500/10 to-orange-500/10 rounded-xl border border-amber-500/20">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Send this presentation to relevant AI Experts for
...
export default PresentationBlueprint;
