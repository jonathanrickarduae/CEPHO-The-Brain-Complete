...
const MOCK_APP_USAGE: AppUsage[] = [
  ...
  },
  {
    ...
    trend: "stable",
    insights: [
      "Research sessions averaging 25 min",
      "15% time on non-work sites",
    ],
  },
  {
    name: "Notion",
    ...
    insights: [
      ...
      "Consider templates for faster creation",
    ],
  },
  {
    name: "Zoom",
...
export function ActiveLearningMode() {
  ...
  const handleToggleActive = () => {
    ...
    toast.success(
      isActive ? "Active Learning paused" : "Active Learning enabled"
    );
  };
  ...
  const handleTogglePause = () => {
    ...
    toast.info(
      isPaused ? "Observation resumed" : "Observation paused for 30 minutes"
    );
  };
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      ...
      default:
        return "bg-gray-500/20 text-foreground/70";
    }
  };
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-foreground">
                Work hours only ({privacySettings.workHoursStart} -{" "}
                {privacySettings.workHoursEnd})
              </span>
            </div>
            <Switch
                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <Badge
                        variant="secondary"
                        className={`ml-2 text-xs ${getCategoryColor(app.category)}`}
                      >
                        {app.category}
                      </Badge>
                    </div>
        ...
        <Card className="bg-card/60 border-border">
          ...
          <CardContent className="space-y-2">
            <div className="flex items-start gap-2 p-2 bg-yellow-500/10 rounded text-sm">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  You switched between Slack and VS Code 12 times in the last
                  hour. Consider batching communication.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-2 p-2 bg-green-500/10 rounded text-sm">
              ...
              <div>
                <span className="font-medium text-foreground">
                  Deep work session achieved
                </span>
                <p className="text-muted-foreground">
                  45-minute uninterrupted coding session this morning. Your most
                  productive time is 9-11am.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-2 p-2 bg-primary/10 rounded text-sm">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Your overall efficiency is up 8% compared to last week. Keep
                  it up!
                </p>
              </div>
            </div>
        ...
        <Card className="bg-card/60 border-border border-dashed">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Active Learning Mode requires the desktop app for screen
              observation. Install it to unlock workflow optimization features.
            </p>
