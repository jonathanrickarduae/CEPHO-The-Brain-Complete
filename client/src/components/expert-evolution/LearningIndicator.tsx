      ...
      : [
          {
            ...
            message: "You prefer morning meetings",
            timestamp: new Date(),
          },
          {
            id: "2",
            type: "vocabulary" as const,
            message: 'Added "synergy" to your vocabulary',
            timestamp: new Date(),
          },
          {
            id: "3",
            type: "decision" as const,
            message: "You usually approve marketing budgets",
            timestamp: new Date(),
          },
        ];
      ...
      <div className="space-y-3">
        {items.slice(0, 5).map(item => {
          ...
          return (
            ...
            >
              <div
                className={cn("p-1.5 rounded-md bg-secondary/50", config.color)}
              >
