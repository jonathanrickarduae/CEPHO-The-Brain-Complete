...
import { CEPHOOrgChart } from "@/components/team-management/CEPHOOrgChart";
import {
  Building2,
  Users,
  Target,
...
const VALUE_PROPS = [
  {
    ...
    description:
      "Access a full C-suite of AI experts without the overhead of traditional executive hires",
  ...
  },
  {
    ...
    description:
      "Continuous monitoring, analysis, and recommendations that never sleep",
  ...
  },
  {
    ...
    description:
      "AI that learns your preferences, style, and business context over time",
  ...
  },
  {
    ...
    description:
      "Your data stays private with bank-level encryption and compliance",
...
const DIFFERENTIATORS = [
  {
    ...
    description:
      "Unlike traditional businesses requiring large teams, CEPHO.Ai enables a single CEO to operate with the capability of a full executive team through AI amplification.",
    icon: Users,
  },
  {
    title: "Learning System",
    description:
      "The Chief of Staff continuously learns from every interaction, building a deep understanding of your preferences, communication style, and business context.",
    icon: Lightbulb,
  },
  {
    title: "Expert Panel Reviews",
    description:
      "Every major decision gets reviewed by a panel of AI SME experts, providing diverse perspectives and catching blind spots before they become problems.",
    icon: BarChart3,
  },
  {
    title: "Advisory Network Integration",
    description:
      "Seamlessly connects to the world's knowledge through real-time data feeds, research papers, market intelligence, and expert networks.",
    icon: Globe,
  },
];
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            The AI-powered executive platform that transforms how businesses
            operate
          </p>
              ...
              <Card className="bg-gradient-to-br from-[#E91E8C]/10 to-purple-500/10 border-[#E91E8C]/30">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                    To democratize access to executive-level intelligence,
                    enabling every founder and CEO to operate with the strategic
                    capability of a Fortune 500 company through AI
                    amplification.
                  </p>
                </CardContent>
              </Card>
                        ...
                        <CardContent className="pt-6">
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              ...
                              <Badge
                                variant="outline"
                                className="mt-2 text-xs bg-green-500/10 text-green-400 border-green-500/30"
                              >
                                {prop.benefit}
                              </Badge>
                            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {PRICING_TIERS.map((tier, idx) => (
                  ...
                  >
                    <CardHeader>
                      {tier.highlight && (
                        <Badge className="w-fit bg-[#E91E8C] mb-2">
                          Most Popular
                        </Badge>
                      )}
              ...
              <Card className="bg-gray-900/50 border-gray-800 mt-8">
                <CardHeader>
                  <CardTitle className="text-white">
                    CEPHO.Ai vs Traditional Approach
                  </CardTitle>
                </CardHeader>
                <CardContent>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-gray-800">
                          ...
                          <th className="text-center py-3 text-muted-foreground">
                            Traditional
                          </th>
                          <th className="text-center py-3 text-[#E91E8C]">
                            CEPHO.Ai
                          </th>
                        </tr>
                      </thead>
