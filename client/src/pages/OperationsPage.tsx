            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="p-3 bg-green-500/10 rounded-lg border border-green-500/20">
                  <h4 className="text-sm font-medium text-green-500 mb-1">Promoters (9–10)</h4>
                  <p className="text-xs text-muted-foreground">Ask for referrals, testimonials, and case studies. These customers are your advocates.</p>
                </div>
                <div className="p-3 bg-yellow-500/10 rounded-lg border border-yellow-500/20">
                  <h4 className="text-sm font-medium text-yellow-500 mb-1">Passives (7–8)</h4>
                  <p className="text-xs text-muted-foreground">Identify what would make them promoters. They are satisfied but not enthusiastic.</p>
                </div>
                <div className="p-3 bg-red-500/10 rounded-lg border border-red-500/20">
                  <h4 className="text-sm font-medium text-red-500 mb-1">Detractors (0–6)</h4>
                  <p className="text-xs text-muted-foreground">Follow up immediately. Understand pain points and work to resolve issues.</p>
                </div>
              </CardContent>
            </Card>
          </div>
