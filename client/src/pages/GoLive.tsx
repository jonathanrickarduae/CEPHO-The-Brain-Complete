...
export default function GoLive() {
  ...
  const getProgress = () => {
    const completed = Object.values(integrationStatuses).filter(
      s => s === "completed"
    ).length;
    ...
    <div className="h-full flex flex-col p-4 md:p-6 overflow-auto">
      ...
      <div className="bg-gradient-to-br from-cyan-500/10 to-purple-500/10 rounded-2xl p-6 mb-6 border border-cyan-500/30">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-foreground/70">
                Complete integrations to go live
              </p>
            </div>
          </div>
        ...
        <div className="flex justify-between mt-2 text-xs text-foreground/60">
          <span>
            {
              Object.values(integrationStatuses).filter(s => s === "completed")
                .length
            }{" "}
            of {integrations.length} integrations
          </span>
          <span>
            {getProgress() === 100 ? "Ready to publish!" : "Keep going..."}
          </span>
        </div>
      </div>
        ...
        <div className="lg:col-span-1">
          {selectedIntegration ? (
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 sticky top-4">
              ...
              <div className="mb-4">
                ...
                <div className="space-y-1">
                  {selectedIntegration.envKeys.map(key => (
                    <code
                      key={key}
                      className="block text-xs bg-gray-900 text-cyan-400 px-2 py-1 rounded"
                    >
                      {key}
                    </code>
                  ))}
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    onClick={() =>
                      updateStatus(selectedIntegration.id, "completed")
                    }
                  ...
                  <button
                    onClick={() =>
                      updateStatus(selectedIntegration.id, "skipped")
                    }
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 text-center">
              ...
              <p className="text-foreground/70">
                Select an integration to see setup instructions
              </p>
            </div>
          )}
        </div>
