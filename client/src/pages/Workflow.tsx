...
function getDeadlineWarning(dueDate: string): {
  type: "overdue" | "urgent" | "soon" | null;
  label: string;
} {
  ...
  if (diffDays < 0)
    return { type: "overdue", label: `${Math.abs(diffDays)}d overdue` };
    ...
    <div className="h-[calc(100vh-56px)] md:h-screen flex flex-col bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <Button
            size="sm"
            className="gap-2 bg-gradient-to-r from-emerald-500 to-green-500 hover:opacity-90"
          >
