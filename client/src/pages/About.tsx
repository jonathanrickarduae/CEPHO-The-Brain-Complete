...
export default function About() {
  ...
  const pillars = [
    ...
    },
    {
      ...
      description: "Access 250+ specialized AI experts across business, health, creativity, and more. Get perspectives from strategists, lawyers, coaches, and specialists on demand.",
      color: "from-cyan-500 to-blue-500"
    },
    {
      icon: Zap,
      title: "Daily Flow",
      description: "Morning Brief → AI Consultation → Workflow Execution → Evening Review. A structured rhythm that maximizes your productivity and wellbeing.",
  ...
  const concepts = [
    {
      ...
      description: "The Brain's core mission is optimizing your daily wellness score. Through mood tracking, task management, and AI guidance, we help you reach peak performance."
    },
    {
      icon: Lightbulb,
      title: "Collective Intelligence",
      description: "Combine your knowledge with AI expertise. The Brain aggregates insights from multiple AI experts to give you well-rounded perspectives on any challenge."
    },
    {
      icon: Layers,
    ...
    },
    {
      ...
      description: "You're always in control. The Brain suggests, drafts, and prepares—but you approve. It's designed to amplify your capabilities, not replace your judgment."
    }
  ];
    ...
    <div className="h-full flex flex-col p-4 md:p-6 overflow-auto">
      ...
      <div className="text-center mb-12">
        <div className="flex justify-center mb-6">
          <NeonBrain className="w-32 h-32" state="thinking" />
        </div>
