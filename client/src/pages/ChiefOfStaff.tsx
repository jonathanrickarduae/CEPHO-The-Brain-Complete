...
const MOCK_CONVERSATIONS: Conversation[] = [
  ...
  {
    id: "conv-2",
    title: "Project A Strategy",
    project: "Project A",
    lastMessage: "The financial projections look solid...",
  ...
  {
    id: "conv-3",
    title: "Sample Project Pitch",
    project: "Project B",
    lastMessage: "I've updated the deck with...",
  ...
  },
  {
    ...
    project: undefined,
    lastMessage: "Your schedule for tomorrow...",
...
const QA_STATUS_CONFIG: Record<
  QAStatus,
  { label: string; color: string; icon: typeof CheckCircle2 }
> = {
  pending: {
    label: "Pending QA",
    color: "text-foreground/70 bg-gray-500/10",
    icon: Clock,
  },
  cos_reviewing: {
    label: "CoS Reviewing",
...
export default function ChiefOfStaff() {
  ...
  const submitSecondaryReviewMutation =
    trpc.qa.submitSecondaryReview.useMutation({
      onSuccess: () => {
        ...
        <div className="max-w-7xl mx-auto flex gap-1">
          {[
            { id: "chat", label: "Chat", icon: MessageSquare },
            {
              ...
              label: "Tasks",
              icon: FolderKanban,
              badge: taskStats.active + taskStats.review,
            },
            {
              id: "quality_gates",
              label: "Quality Gates",
        ...
        {viewMode === "chat" && (
          <>
              ...
              <div className="w-64 border-r border-white/10 bg-white/5 flex flex-col">
                <div className="p-3 border-b border-white/10">
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full gap-2 border-white/20 text-foreground/80 hover:bg-white/5"
                    onClick={() => {
                      clearHistory();
            ...
            <div className="flex-1 flex flex-col">
              {/* Messages - Scrollable */}
              <div
                className={`flex-1 overflow-y-auto ${isMobile ? "pb-40" : ""}`}
              >
                        ...
                        {msg.from === "twin" && (
                          <div className="flex items-center gap-1 mt-2">
                            <button
                              onClick={() => {
                                setMessageInput(
                                  "Please verify the assumptions in your last response. What evidence supports these claims?"
                                );
                                inputRef.current?.focus();
                              }}
                            ...
                            <button
                              onClick={() => {
                                setMessageInput(
                                  "Play devil's advocate: What could go wrong with this approach? What are the counterarguments?"
                                );
                                inputRef.current?.focus();
                              }}
              ...
              <div
                className={`shrink-0 border-t border-white/10 bg-gray-900/95 backdrop-blur-xl px-4 py-3 ${isMobile ? "fixed bottom-0 left-0 right-0 z-40 pb-20" : ""}`}
              >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-foreground/70">
                          Decision-making, risk, communication, values
                        </p>
                      </div>
                    </div>
              ...
              <div className="mt-6">
                ...
                <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
                  <p className="text-sm text-muted-foreground mb-3">
                    Chief of Staff learns optimal prompting for each SME based
                    on QA feedback.
                  </p>
                    ...
                    {[
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className="text-xs text-muted-foreground">
                            {Math.floor(Math.random() * 20 + 5)} interactions
                          </span>
                        </div>
                      </div>
                    ))}
                  ...
                  {[
                    ...
                    const isPast =
                      [
                        ...
                        "secondary_reviewing",
                        "verified",
                      ].indexOf(selectedTask.qaStatus) > i;
                    return (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {selectedTask.cosScore && (
                    <div className="p-4 bg-secondary/30 rounded-xl">
                      <p className="text-sm text-muted-foreground mb-1">
                        Chief of Staff Score
                      </p>
                      <p
                        className={`text-3xl font-bold ${selectedTask.cosScore >= 9 ? "text-emerald-400" : "text-amber-400"}`}
                      >
                  ...
                  {selectedTask.secondaryAIScore && (
                    <div className="p-4 bg-secondary/30 rounded-xl">
                      ...
                      <p
                        className={`text-3xl font-bold ${selectedTask.secondaryAIScore >= 9 ? "text-emerald-400" : "text-amber-400"}`}
                      >
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedTask.assignedExperts.map(expert => (
                    <Badge key={expert} variant="outline">
                      {expert}
                    </Badge>
                  ))}
                </div>
