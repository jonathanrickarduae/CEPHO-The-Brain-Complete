...
const SAMPLE_PENDING_REVIEWS: PendingReview[] = [
  ...
  },
  {
    ...
    status: "pending_user",
    jimFeedback:
      "The market sizing needs more rigorous bottom-up analysis. The TAM figure of $50B seems inflated without proper segmentation. Also, the competitive moat section is weak - what specifically prevents a well-funded competitor from replicating this in 18 months?",
    jimScore: 65,
  },
  {
    id: "3",
    ...
    jimFeedback:
      "The drag-along provisions are too aggressive for minority shareholders. This will scare off sophisticated angels. Recommend 75% threshold instead of 51%. The vesting cliff should be 12 months, not 6 - you want committed founders.",
    jimScore: 45,
  },
];
...
export default function QADashboardPage() {
  ...
  const pendingJimCount = pendingReviews.filter(
    r => r.status === "pending_jim"
  ).length;
  const pendingUserCount = pendingReviews.filter(
    r => r.status === "pending_user" || r.status === "revision_needed"
  ).length;
      ...
      >
        <div className="flex items-center justify-between">
          <TabsList className="bg-gray-800/50">
            ...
            <TabsTrigger
              value="jim-review"
              className="data-[state=active]:bg-primary relative"
            >
        ...
        <TabsContent value="jim-review" className="space-y-6">
          ...
          <JimShortExpert context="You're reviewing documents prepared by the Chief of Staff AI. Be direct and constructive." />
