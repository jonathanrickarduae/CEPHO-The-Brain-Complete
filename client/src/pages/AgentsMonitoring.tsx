      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Monitor performance, ratings, and daily reports
          </p>
        </div>
          ...
          <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700/50">
            <div className="flex justify-between items-start mb-6">
              <div>
                <h2 className="text-2xl font-bold mb-1">
                  {selectedAgent.name} - Daily Report
                </h2>
                <p className="text-gray-400">
                  {selectedAgent.dailyReport.date}
                </p>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {selectedAgent.dailyReport.improvements.map(
                    (improvement, i) => (
                      <li
                        key={i}
                        className="text-sm text-gray-300 flex items-start gap-2"
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {selectedAgent.dailyReport.suggestions.map(
                    (suggestion, i) => (
                      <li
                        key={i}
                        className="text-sm text-gray-300 flex items-start gap-2"
              ...
              <div>
                ...
                <div className="space-y-3">
                  {selectedAgent.dailyReport.requestsForApproval.map(
                    request => (
                      <div
                        key={request.id}
                      ...
                      >
                        ...
                        {request.status === "pending" ? (
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                approveRequest(selectedAgent.id, request.id)
                              }
                            ...
                            <button
                              onClick={() =>
                                denyRequest(selectedAgent.id, request.id)
                              }
