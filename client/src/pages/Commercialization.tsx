...
const mockCompetitors = [
  {
    ...
    score: 85,
    change: -2,
    features: ["AI Drafts", "Keyboard-first", "Social Insights"],
  },
  {
    id: 2,
    name: "Motion",
    ...
    score: 82,
    change: 3,
    features: ["Auto-scheduling", "Task Planner", "Calendar AI"],
  },
  {
    id: 3,
    name: "Personal AI",
    ...
    score: 78,
    change: 5,
    features: ["Memory Bank", "Training Studio", "Voice Clone"],
  },
  {
    id: 4,
    name: "Lindy",
    ...
    score: 71,
    change: -1,
    features: ["Agent Builder", "Autonomous Actions", "Integrations"],
  },
  {
    id: 5,
    name: "Granola",
    ...
    score: 65,
    change: 0,
    features: ["Meeting Notes", "Human-AI Collab", "Privacy-first"],
  },
];
...
const mockThreats = [
  {
    ...
    type: "threat",
    severity: "critical",
    title: "Personal AI launched voice cloning",
    description: "Direct competition to Chief of Staff voice features",
    date: "2 days ago",
  },
  {
    id: 2,
    type: "opportunity",
    severity: "high",
    title: "Motion lacks wellness tracking",
    description: "Gap in market for productivity + wellness combination",
    date: "1 week ago",
  },
  {
    id: 3,
    type: "threat",
    severity: "medium",
    title: "Superhuman expanding to calendar",
    description: "Moving into adjacent market",
    date: "3 days ago",
  },
];
...
const mockRecommendations = [
  {
    ...
    category: "product",
    priority: "critical",
    title: "Accelerate voice clone feature",
    expert: "Maxwell Patent",
    status: "proposed",
  },
  {
    id: 2,
    category: "regulatory",
    priority: "high",
    title: "File provisional patent for wellness algorithm",
    expert: "Maxwell Patent",
    status: "in_progress",
  },
  {
    ...
    category: "marketing",
    priority: "medium",
    title: "Position against Personal AI on privacy",
...
export default function Commercialization() {
  const [activeTab, setActiveTab] = useState<
    "overview" | "competitors" | "threats" | "strategy" | "regulatory"
  >("overview");
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            <div className="relative">
              ...
              <div
                className={`absolute -bottom-1 -right-1 px-2 py-1 rounded-full text-xs font-bold flex items-center gap-1 ${
                  scoreChange >= 0
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-1">
                Cepho's Competitive Position
              </h2>
              <p className="text-foreground/70 mb-3">
                Based on feature parity, unique value, and market dynamics
              </p>
            ...
            <div className="flex flex-wrap gap-6">
              <div className="flex items-center gap-4 bg-gray-900/50 rounded-xl p-4">
                <div className="w-16 h-16 rounded-xl bg-white flex items-center justify-center p-2">
                  <img
                    alt="Commercialization strategy diagram"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-900 rounded-lg p-4">
                  <div className="text-2xl font-bold text-red-400">
                    {mockThreats.filter(t => t.type === "threat").length}
                  </div>
                  <div className="text-sm text-foreground/70">
                    Active Threats
                  </div>
                ...
                <div className="bg-gray-900 rounded-lg p-4">
                  <div className="text-2xl font-bold text-green-400">
                    {mockThreats.filter(t => t.type === "opportunity").length}
                  </div>
                  <div className="text-sm text-foreground/70">
                    Opportunities
                  </div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {competitor.features.map((feature, i) => (
                    <span
                      key={i}
                      className="px-2 py-1 bg-gray-700 text-foreground/80 text-xs rounded-full"
                    >
                      {feature}
                    </span>
                  ))}
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="space-y-3">
                {mockThreats
                  .filter(t => t.type === "threat")
                  .map(threat => (
                    <div
                      key={threat.id}
                      className="bg-gray-800 rounded-xl p-4 border border-red-500/30"
                    >
            ...
            <div>
              ...
              <div className="space-y-3">
                {mockThreats
                  .filter(t => t.type === "opportunity")
                  .map(opp => (
                    <div
                      key={opp.id}
                      className="bg-gray-800 rounded-xl p-4 border border-green-500/30"
                    >
                      <div className="flex items-start justify-between mb-2">
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-purple-500/10 to-cyan-500/10 rounded-xl p-6 border border-purple-500/30">
            ...
            <p className="text-foreground/70 mb-4">
              Regulations can create defensible moats. Early compliance with
              strict regulations (like EU AI Act) can be a competitive advantage
              as competitors struggle to catch up.
            </p>
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`px-2 py-0.5 rounded text-xs ${
                        reg.moatPotential === "high"
                          ? "bg-purple-500/20 text-purple-400"
                          : reg.moatPotential === "medium"
                            ? "bg-blue-500/20 text-blue-400"
                            : "bg-gray-700 text-foreground/70"
                      }`}
                    >
