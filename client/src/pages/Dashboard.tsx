...
import {
  MobileInputSheet,
  QuickInputTrigger,
} from "@/components/shared/MobileInputSheet";
import { useIsMobile } from "@/hooks/useMobile";
import { PullToRefresh } from "@/components/shared/PullToRefresh";
import {
  GettingStartedChecklist,
  useOnboardingStatus,
} from "@/components/shared/GettingStartedChecklist";
import {
  InsightsPanel,
  InlineNudge,
  useNudgeEngine,
} from "@/components/shared/IntelligentNudges";
...
export default function Dashboard() {
  ...
  // Governance State
  const [governanceMode, setGovernanceMode] = useState<"omni" | "governed">(
    "omni"
  );
  ...
  const buttons = [
    // TOP ROW - The Flow
    {
      ...
      path: "/daily-brief",
      tooltip:
        "Start your day here! Get personalized briefings, action items, and intelligence updates.",
    },
    {
      id: 2,
      label: "AI-SMEs",
      ...
      path: "/ai-experts",
      tooltip:
        "Access 287+ AI specialists. Assemble expert teams for any project or challenge.",
    },
    {
      id: 3,
      label: "WORKFLOW",
      ...
      path: "/workflow",
      tooltip:
        "Track all your projects in one place. See status, blockers, and delivery timelines.",
    },
    // BOTTOM ROW - Support
    {
      id: 4,
      ...
      tooltip:
        "Your AI counterpart that learns from you. Train it to handle tasks autonomously.",
    },
    {
      id: 5,
      label: "LIBRARY",
      ...
      path: "/library",
      tooltip:
        "Your knowledge repository. Store documents, AI images, charts, and project files.",
    },
    {
      id: 6,
      label: "THE VAULT",
      ...
      color: "#64748b",
      tooltip:
        "Secure, encrypted storage for sensitive data. Connect integrations and manage security.",
      path: "/vault",
    },
  ];
              ...
              {(() => {
                ...
                const latestMood =
                  todaysMoods.length > 0
                    ? todaysMoods[todaysMoods.length - 1]
                    : null;
          ...
          <div className="max-w-3xl mx-auto w-full mb-6">
            {isMobile ? (
              ...
              <>
                ...
                <div
                  className="flex items-center gap-3 bg-card/80 border-2 border-primary/30 rounded-2xl px-4 py-4 focus-within:border-primary/60 focus-within:ring-2 focus-within:ring-primary/20 transition-all duration-300 shadow-lg shadow-primary/5"
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      boxShadow: `inset 0 0 15px ${btn.color}15, 0 0 10px ${btn.color}20`,
                    }}
                  ></div>
          ...
          {isMobile && (
            <MobileInputSheet
              ...
              onSubmit={value => {
                ...
                setLocation(
                  `/digital-twin?message=${encodeURIComponent(value)}`
                );
              }}
            />
          )}
