...
export default function Vault() {
  ...
  const integrations = [
    ...
    },
    {
      ...
      alert: "Consider switching to Pitch.com",
    },
    {
      id: 4,
      name: "Manus AI",
  ...
  const upcomingContracts = contractRenewals.filter(
    c => c.status === "upcoming"
  ).length;
  ...
  const securityEvents = [
    ...
    },
    {
      id: 2,
      type: "blocked",
      message: "Brute force prevented",
      location: "Bot Network",
      time: "5 hours ago",
      severity: "high",
    },
    {
              ...
              {integrations.map(integration => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center ${integration.color}`}
                      >
                  ...
                  {integration.alert && (
                    <p
                      className={`text-xs mt-2 ${integration.status === "broken" ? "text-red-400" : "text-amber-400"}`}
                    >
                      ⚠️ {integration.alert}
                    </p>
                  )}
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right shrink-0">
                        ...
                        {contract.autoRenew && (
                          <Badge
                            variant="outline"
                            className="text-[8px] mt-1 border-green-500/50 text-green-400"
                          >
                            Auto-renew
                          </Badge>
                        )}
