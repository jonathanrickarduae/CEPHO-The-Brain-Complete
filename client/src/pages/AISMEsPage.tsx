    ...
    <div className="h-[calc(100vh-56px)] md:h-screen flex flex-col bg-background">
          ...
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-3 text-sm font-medium transition-colors border-b-2 whitespace-nowrap ${
                viewMode === tab.id
                  ? "text-[var(--brain-cyan)] border-cyan-400"
        ...
        <div className="max-w-7xl mx-auto flex items-center gap-2">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-full text-xs font-medium transition-colors shrink-0 ${
              selectedPanel === "all"
                ? "bg-[var(--brain-cyan)]/20 text-[var(--brain-cyan)] border border-cyan-500/30"
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-sm transition-colors ${
                        selectedExpertType === "all"
                          ? "bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-[var(--brain-cyan)] border border-cyan-500/30"
                ...
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  ...
                  <div className="flex items-center gap-1 border border-white/20 rounded-lg p-1">
                    <button
                      ...
                      className={`p-2 rounded ${viewStyle === "grid" ? "bg-[var(--brain-cyan)]/20 text-[var(--brain-cyan)]" : "text-foreground/70"}`}
                    >
                      <Grid className="w-4 h-4" />
                    </button>
                    <button
                      onClick={() => setViewStyle("list")}
                      className={`p-2 rounded ${viewStyle === "list" ? "bg-[var(--brain-cyan)]/20 text-[var(--brain-cyan)]" : "text-foreground/70"}`}
                    >
                          ...
                          {viewStyle === "list" && (
                            <div className="flex items-center gap-4">
                              <div className="flex items-center gap-1">
                                <Activity className="w-4 h-4 text-[var(--brain-cyan)]" />
                          ...
                          <>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3 text-xs text-muted-foreground">
                                <span className="flex items-center gap-1">
                                  <Activity className="w-3 h-3 text-[var(--brain-cyan)]" />
                                  {expert.performanceScore}%
                                </span>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="bg-white/5 rounded-2xl border border-white/10 overflow-hidden">
                <div className="px-4 py-3 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border-b border-cyan-500/30 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Trophy className="w-5 h-5 text-[var(--brain-cyan)]" />
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-right">
                            <div className="text-lg font-bold text-[var(--brain-cyan)]">
                              {expert.performanceScore}%
                            </div>
                    ...
                    {selectedExperts.length > 0 ? (
                      <div className="flex flex-wrap gap-2">
                        {selectedExperts.map(expert => (
                          <div
                            key={expert.id}
                            className="flex items-center gap-2 px-3 py-2 bg-[var(--brain-cyan)]/10 border border-cyan-500/30 rounded-full"
                          >
      ...
      {showCompareModal && compareExpertData.length > 0 && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-background border border-white/20 rounded-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden">
