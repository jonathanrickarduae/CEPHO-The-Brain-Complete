...
const mockReviewItems: ReviewItem[] = [
  {
    ...
    context:
      "Client sent revised proposal yesterday. Your Chief of Staff drafted a response based on your communication style.",
  ...
  },
  {
    ...
    context:
      "Budget submission deadline is tomorrow. Currently ranked 4th in your task list.",
  ...
  },
  {
    ...
    description:
      "Analysis complete: Vendor B recommended based on cost-benefit analysis",
    source: "ai_expert",
...
export default function ReviewQueue() {
  ...
  const [filter, setFilter] = useState<"all" | "digital_twin" | "ai_expert">(
    "all"
  );
      ...
      <div className="h-full flex flex-col p-4 md:p-6 overflow-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            Items awaiting your approval from Chief of Staff and AI Experts
          </p>
        </div>
        ...
        {isMobile && filteredItems.length > 0 && <SwipeHint className="mb-4" />}
