...
const AGENTS = [
  ...
  },
  {
    ...
    category: "workflow",
    specialization: "Workflow & Process",
    description: "Tracks budgets, forecasts spending, and flags variances",
  },
  {
    id: "digital_twin",
    name: "Digital Twin",
    ...
    description:
      "Personalised AI assistant that learns your preferences and style",
  },
  {
    id: "learning_curator",
    ...
    category: "personal",
    specialization: "Personal Development",
    description: "Curates personalised learning content and development plans",
  },
  {
    id: "health_coach",
    name: "Health & Wellbeing Coach",
    category: "personal",
    specialization: "Personal Development",
    description: "Supports physical and mental wellbeing, work-life balance",
  },
  {
    ...
    category: "personal",
    specialization: "Personal Development",
    description: "Builds and manages professional network and relationships",
  },
  {
  ...
  return [
    {
      ...
      improvements: [
        `Improved ${specialization} accuracy by ${2 + (seed % 5)}%`,
          ...
          ? [
              {
                ...
                description:
                  "Request to integrate new API for enhanced performance",
                status: "pending",
              },
            ]
          : [],
