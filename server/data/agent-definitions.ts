...
export const AGENT_DEFINITIONS: AgentDefinition[] = [
  ...
  // ============================================================
  {
    ...
    description:
      "Drafts professional emails that match the user's writing style, tone, and communication preferences. Learns from past emails to improve accuracy and personalization.",
    initialSkills: [
      "Email writing",
      "Tone matching",
  ...
  },
  {
    ...
    description:
      "Manages calendar, schedules meetings, finds optimal time slots, sends invitations, and handles rescheduling with minimal user intervention.",
    initialSkills: [
      "Calendar management",
  ...
  },
  {
    ...
    description:
      "Analyzes incoming communications (email, Slack, Teams) and prioritizes them based on urgency, importance, and user preferences. Flags critical messages and filters noise.",
    initialSkills: [
      "Message analysis",
      "Priority scoring",
  ...
  },
  {
    ...
    description:
      "Generates draft responses to frequently asked questions and common inquiries, maintaining user's voice and providing accurate information.",
    initialSkills: [
      "FAQ management",
      "Response templating",
  ...
  },
  {
    ...
    description:
      "Tracks conversations requiring follow-up, sends reminders, and drafts follow-up messages at appropriate intervals.",
    initialSkills: [
      "Follow-up tracking",
      "Reminder scheduling",
      "Context retention",
  ...
  },
  {
    ...
    description:
      "Manages communication with key stakeholders, prepares updates, and maintains relationship quality through consistent, professional engagement.",
    initialSkills: [
  ...
  },
  {
    ...
    description:
      "Facilitates internal team communication, distributes updates, manages team channels, and ensures information flows efficiently across the organization.",
    initialSkills: [
      "Team communication",
      "Channel management",
  ...
  },
  {
    ...
    description:
      "Handles urgent communications, escalates critical issues, and manages crisis communication protocols with speed and accuracy.",
    initialSkills: [
      "Crisis detection",
  ...
  // ============================================================
  {
    ...
    description:
      "Creates comprehensive business reports, executive summaries, and analytical documents with proper structure, data visualization, and professional formatting.",
    initialSkills: [
      "Report writing",
      "Data analysis",
      "Executive summaries",
  ...
  },
  {
    ...
    description:
      "Designs compelling presentations with effective storytelling, visual design, and data visualization optimized for impact and clarity.",
    initialSkills: [
      "Presentation design",
      "Storytelling",
      "Visual design",
  ...
  },
  {
    ...
    description:
      "Creates engaging social media content, schedules posts, analyzes performance, and optimizes posting strategies across multiple platforms.",
    initialSkills: [
  ...
  },
  {
    ...
    description:
      "Writes engaging, SEO-optimized blog posts and articles that match brand voice, target audience interests, and drive traffic.",
    initialSkills: [
      "Blog writing",
      "SEO optimization",
      "Content research",
  ...
  },
  {
    ...
    description:
      "Creates clear, comprehensive technical documentation, user guides, API documentation, and knowledge base articles.",
    initialSkills: [
      "Technical writing",
  ...
  },
  {
    ...
    description:
      "Writes engaging video scripts, creates storyboards, and plans video content for maximum impact and viewer retention.",
    initialSkills: [
      "Script writing",
      "Storyboarding",
      "Video planning",
  ...
  },
  {
    ...
    description:
      "Curates relevant content, writes newsletter copy, manages subscriber lists, and optimizes email campaigns for engagement.",
    initialSkills: [
      "Content curation",
      "Email copywriting",
  ...
  // ============================================================
  {
    ...
    description:
      "Conducts comprehensive market research, analyzes competitors, identifies trends, and provides actionable insights for strategic decision-making.",
    initialSkills: [
      "Market analysis",
  ...
  },
  {
    ...
    description:
      "Analyzes complex datasets, creates visualizations, identifies patterns, and generates data-driven insights to support decision-making.",
    initialSkills: [
      "Data analysis",
  ...
  },
  {
    ...
    description:
      "Monitors business metrics, tracks KPIs, creates dashboards, and provides regular performance reports with actionable recommendations.",
    initialSkills: [
      "KPI tracking",
      "Dashboard creation",
  ...
  },
  {
    ...
    description:
      "Identifies potential risks, assesses impact and probability, develops mitigation strategies, and monitors risk indicators.",
    initialSkills: [
      "Risk assessment",
      "Impact analysis",
      "Mitigation planning",
  ...
  },
  {
    ...
    description:
      "Analyzes historical data, identifies emerging trends, forecasts future developments, and provides strategic foresight.",
    initialSkills: [
      "Trend analysis",
      "Forecasting",
      "Pattern recognition",
  ...
  },
  {
    ...
    description:
      "Analyzes customer data, identifies behavior patterns, creates customer segments, and provides insights for personalization and engagement.",
    initialSkills: [
      "Customer analysis",
      "Segmentation",
      "Behavior tracking",
  ...
  },
  {
    ...
    description:
      "Performs financial analysis, creates financial models, evaluates investments, and provides financial insights and recommendations.",
    initialSkills: [
      "Financial modeling",
      "Investment analysis",
      "Valuation",
  ...
  },
  {
    ...
    description:
      "Monitors competitors, analyzes their strategies, identifies competitive advantages and threats, and provides strategic recommendations.",
    initialSkills: [
      "Competitor analysis",
      "Strategic analysis",
      "SWOT analysis",
  ...
  },
  {
    ...
    description:
      "Monitors brand mentions, analyzes sentiment, tracks reputation, and provides alerts for potential issues or opportunities.",
    initialSkills: [
      "Sentiment analysis",
      "Brand monitoring",
      "Reputation tracking",
  ...
  },
  {
    ...
    description:
      "Analyzes workflows, identifies bottlenecks, recommends optimizations, and measures improvement impact.",
    initialSkills: [
      "Process analysis",
  ...
  // ============================================================
  {
    ...
    description:
      "Compiles overnight updates, prioritizes information, prepares morning briefing with key metrics, news, and action items.",
    initialSkills: [
  ...
  },
  {
    ...
    description:
      "Organizes tasks, sets priorities, manages deadlines, sends reminders, and tracks completion across multiple projects.",
    initialSkills: [
      "Task management",
      "Priority setting",
      "Deadline tracking",
  ...
  },
  {
    ...
    description:
      "Organizes inbox, filters spam, categorizes emails, archives completed items, and maintains inbox zero.",
    initialSkills: [
      "Email organization",
      "Filtering",
      "Categorization",
  ...
  },
  {
    ...
    description:
      "Organizes files, maintains folder structure, tags documents, manages versions, and ensures easy retrieval.",
    initialSkills: [
      "File organization",
      "Tagging",
      "Version control",
  ...
  },
  {
    ...
    description:
      "Tracks expenses, categorizes transactions, manages receipts, prepares expense reports, and monitors budgets.",
    initialSkills: [
      "Expense tracking",
      "Categorization",
      "Receipt management",
  ...
  },
  {
    ...
    description:
      "Plans travel, books flights and hotels, creates itineraries, manages travel documents, and handles changes.",
    initialSkills: [
      "Travel planning",
      "Booking management",
      "Itinerary creation",
  ...
  },
  {
    ...
    description:
      "Prepares meeting materials, creates agendas, gathers relevant documents, sends pre-reads, and ensures all participants are prepared.",
    initialSkills: [
      "Meeting preparation",
      "Agenda creation",
      "Material gathering",
  ...
  },
  {
    ...
    description:
      "Compiles end-of-day summary with accomplishments, pending items, tomorrow's priorities, and key metrics.",
    initialSkills: [
      "Summary creation",
      "Progress tracking",
      "Metrics compilation",
  ...
  // ============================================================
  {
    ...
    description:
      "Helps define goals, creates strategic plans, breaks down objectives into actionable steps, and tracks progress toward goals.",
    initialSkills: [
      "Goal setting",
      "Strategic planning",
      "Objective breakdown",
  ...
  },
  {
    ...
    description:
      "Provides decision support by analyzing options, weighing pros and cons, assessing risks, and recommending optimal choices.",
    initialSkills: [
      "Decision analysis",
      "Option evaluation",
      "Risk assessment",
  ...
  },
  {
    ...
    description:
      "Creates scenario plans, develops contingencies, models different outcomes, and prepares for various futures.",
    initialSkills: [
      "Scenario planning",
  ...
  },
  {
    ...
    description:
      "Optimizes resource allocation across projects, balances priorities, maximizes ROI, and ensures efficient resource utilization.",
    initialSkills: [
      "Resource allocation",
      "Optimization",
      "Priority balancing",
  ...
  },
  {
    ...
    description:
      "Identifies innovation opportunities, tracks emerging technologies, evaluates potential applications, and recommends strategic innovations.",
    initialSkills: [
      "Innovation scouting",
      "Technology tracking",
  ...
  },
  {
    ...
    description:
      "Provides strategic advice, develops long-term plans, aligns initiatives with vision, and guides strategic decision-making.",
    initialSkills: [
      "Strategic advising",
      "Long-term planning",
      "Vision alignment",
  ...
  // ============================================================
  {
    ...
    description:
      "Identifies automation opportunities, implements workflows, integrates tools, and streamlines processes for efficiency.",
    initialSkills: [
      "Workflow automation",
      "Process design",
      "Tool integration",
  ...
  },
  {
    ...
    description:
      "Documents processes, creates SOPs, maintains process library, and ensures knowledge retention and consistency.",
    initialSkills: [
  ...
  },
  {
    ...
    description:
      "Monitors quality, identifies issues, implements quality controls, and ensures consistent high-quality outputs.",
    initialSkills: [
      "Quality assurance",
  ...
  },
  {
    ...
    description:
      "Coordinates complex multi-step workflows, manages dependencies, ensures smooth handoffs, and tracks workflow progress.",
    initialSkills: [
  ...
  },
  {
    ...
    description:
      "Integrates tools and systems, ensures data flows smoothly, maintains integrations, and troubleshoots connection issues.",
    initialSkills: [
      "System integration",
      "API management",
      "Data flow design",
  ...
  },
  {
    ...
    description:
      "Continuously analyzes processes, identifies improvement opportunities, implements optimizations, and measures impact.",
    initialSkills: [
      "Process analysis",
  ...
  // ============================================================
  {
    ...
    description:
      "Collects feedback from users and stakeholders, analyzes responses, identifies patterns, and generates actionable insights.",
    initialSkills: [
      "Feedback collection",
      "Survey design",
      "Response analysis",
  ...
  },
  {
    ...
    description:
      "Tracks performance metrics, identifies trends, generates reports, and provides recommendations for improvement.",
    initialSkills: [
  ...
  },
  {
    ...
    description:
      "Manages knowledge base, curates content, ensures information is current, and facilitates knowledge sharing.",
    initialSkills: [
      "Knowledge management",
      "Content curation",
  ...
  },
  {
    ...
    description:
      "Researches industry best practices, evaluates applicability, recommends adoption, and tracks implementation success.",
    initialSkills: [
  ...
  },
  {
    ...
    description:
      "Continuously learns new skills, discovers tools and techniques, proposes capability enhancements, and drives agent ecosystem improvement.",
    initialSkills: [
