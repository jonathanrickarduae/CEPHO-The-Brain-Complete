...
export const REVIEW_EXPERTS = [
  {
    ...
    avatar: "👨‍💼",
    systemPrompt:
      "You are Victor Sterling, a value investor combining the wisdom of Warren Buffett, Charlie Munger, and Peter Lynch. Focus on intrinsic value, competitive moats, and long-term sustainability.",
  },
  {
    id: "inv-002",
    name: "Marcus Macro",
    ...
    avatar: "📊",
    systemPrompt:
      "You are Marcus Macro, a macro economist combining Ray Dalio, George Soros, and Howard Marks. Focus on economic cycles, market timing, and risk management.",
  },
  {
    id: "str-001",
    ...
    avatar: "🎯",
    systemPrompt:
      "You are Alexandra Strategy, a corporate strategist with McKinsey-level rigor. Focus on competitive positioning, strategic options, and execution feasibility.",
  },
  {
    id: "mkt-001",
    name: "Maya Marketing",
    ...
    avatar: "📈",
    systemPrompt:
      "You are Maya Marketing, a growth marketing expert. Focus on customer acquisition, brand positioning, and go-to-market effectiveness.",
  },
  {
    id: "sal-001",
    name: "Simon Sales",
    ...
    avatar: "🤝",
    systemPrompt:
      "You are Simon Sales, an enterprise sales expert. Focus on sales strategy, pricing optimization, and revenue scalability.",
  },
  {
    id: "tech-001",
    name: "Theo Tech",
    ...
    avatar: "💻",
    systemPrompt:
      "You are Theo Tech, a technology strategist. Focus on technical feasibility, scalability, and innovation potential.",
  },
  {
    id: "ops-001",
    ...
    avatar: "⚙️",
    systemPrompt:
      "You are Oliver Operations, an operations expert. Focus on execution capability, operational efficiency, and scalability.",
  },
  {
    id: "leg-001",
    name: "Laura Legal",
    ...
    avatar: "⚖️",
    systemPrompt:
      "You are Laura Legal, a corporate lawyer. Focus on legal risks, regulatory compliance, and contractual considerations.",
  },
];
...
export const BUSINESS_TEMPLATES = [
  {
    ...
    name: "SaaS / Software",
    description:
      "Software-as-a-Service and subscription-based software businesses",
    icon: "💻",
    sectionWeights: {
    ...
    guidance: {
      "pricing-strategy":
        "Focus on subscription tiers, annual vs monthly pricing, and expansion revenue potential.",
      "financial-projections":
        "Emphasize MRR growth, churn assumptions, and path to profitability.",
      "product-technology":
        "Detail the tech stack, scalability architecture, and product roadmap.",
    },
  },
  {
    id: "ecommerce",
    ...
    guidance: {
      "go-to-market":
        "Detail customer acquisition channels, influencer strategy, and brand positioning.",
      "team-operations":
        "Focus on fulfillment, inventory management, and supply chain resilience.",
      "pricing-strategy":
        "Address margin structure, promotional strategy, and competitive pricing.",
    },
  },
  {
    id: "marketplace",
    ...
    guidance: {
      "go-to-market":
        "Address the chicken-and-egg problem and initial liquidity strategy.",
      "competitive-landscape":
        "Focus on network effects, switching costs, and winner-take-all dynamics.",
      "pricing-strategy":
        "Detail take rate structure, pricing for both sides, and monetization timeline.",
    },
  },
  {
    id: "fintech",
    ...
    guidance: {
      "risk-assessment":
        "Thoroughly address regulatory requirements, compliance framework, and risk management.",
      "financial-projections":
        "Detail unit economics, capital requirements, and path to profitability.",
      "product-technology":
        "Focus on security, data protection, and integration capabilities.",
    },
  },
  {
    id: "healthcare",
    ...
    guidance: {
      "risk-assessment":
        "Address FDA/regulatory pathway, clinical trial requirements, and liability considerations.",
      "product-technology":
        "Detail clinical validation, efficacy data, and integration with healthcare systems.",
      "team-operations":
        "Emphasize clinical advisory board, regulatory expertise, and healthcare partnerships.",
    },
  },
  {
    id: "b2b-services",
    ...
    description:
      "Professional services, consulting, and B2B service businesses",
    icon: "🤝",
    sectionWeights: {
      "executive-summary": 1.0,
      "market-analysis": 1.0,
    ...
    guidance: {
      "team-operations":
        "Focus on talent acquisition, training, and scaling service delivery.",
      "go-to-market":
        "Detail enterprise sales strategy, partnership channels, and thought leadership.",
      "pricing-strategy":
        "Address pricing models, value-based pricing, and margin optimization.",
    },
  },
];
...
export function getExpertsForSection(sectionId: string) {
  ...
  return REVIEW_EXPERTS.filter(e =>
    section.expertCategories.includes(e.category)
  );
}
...
Provide your expert assessment.`;
  ...
  try {
        ...
        json_schema: {
          ...
          schema: {
            ...
            properties: {
              insight: {
                type: "string",
                description: "Detailed analysis of the section",
              },
    ...
    return {
      ...
      score: 70,
      recommendations: [
        "Provide more detailed content for thorough analysis",
...
export async function reviewBusinessPlan(
  ...
  for (const section of BUSINESS_PLAN_SECTIONS) {
    ...
    const avgScore = Math.round(
      expertInsights.reduce((sum, i) => sum + i.score, 0) /
...
export async function selectExpertTeam(
  ...
  const expertDescriptions = availableExperts
    .map(e => `- ${e.id}: ${e.name} (${e.category}) - ${e.specialty}`)
    .join("\n");
...
${businessPlanContent || "No specific content provided. Please select a balanced team covering all major business plan areas."}`;
  ...
  try {
    ...
    return {
      ...
      teamComposition: selection.teamComposition.filter(
    ...
    return {
      ...
      reasoning:
        "Default balanced team selected to cover all major business plan areas including finance, strategy, marketing, sales, technology, and operations.",
      teamComposition: [
        {
          expertId: "inv-001",
          role: "Lead Financial Reviewer",
          rationale:
            "Essential for evaluating financial projections and funding requirements",
        },
        {
          expertId: "str-001",
          role: "Strategy Lead",
          rationale:
            "Critical for assessing competitive positioning and strategic direction",
        },
        {
          expertId: "mkt-001",
          role: "Marketing Specialist",
          rationale:
            "Key for evaluating go-to-market strategy and customer acquisition",
        },
        {
          expertId: "sal-001",
          role: "Revenue Analyst",
          rationale:
            "Important for pricing strategy and sales scalability assessment",
        },
        {
          expertId: "tech-001",
          role: "Technology Reviewer",
          rationale:
            "Necessary for product and technology feasibility analysis",
        },
        {
          expertId: "ops-001",
          role: "Operations Analyst",
          rationale:
            "Required for operational plan and execution capability review",
        },
      ],
    };
  }
