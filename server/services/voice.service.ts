...
export async function textToSpeech(
  ...
  if (!apiKey) {
    throw new Error(
      "ElevenLabs API key not configured. Please add ELEVENLABS_API_KEY to your environment."
    );
  }
 ...
 */
export function getExpertVoiceInfo(
  expertId: string
): (typeof EXPERT_VOICE_MAP)[string] | null {
