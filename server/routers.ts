...
import { qualityGatesRouter } from "./routers/project/quality-gates.router";
import { blueprintRouter } from "./routers/project/blueprint.router";
import { smeRouter } from "./routers/ai/sme.router";
import { digitalTwinRouter } from "./routers/ai/digital-twin.router";
import { digitalTwinTrainingRouter } from "./routers/training/digital-twin-training.router";
import { chiefOfStaffTrainingRouter } from "./routers/training/chief-of-staff-training.router";
import { blueprintsRouter } from "./routers/project/blueprints.router";
import { chiefOfStaffRouter } from "./routers/ai/chief-of-staff.router";
import { deepDiveRouter } from "./routers/project/deep-dive.router";
import { businessPlanRouter } from "./routers/business/business-plan.router";
import { debugRouter } from "./routers/debug.router";
import { cleanupRouter } from "./routers/cleanup.router";
import { asanaRouter } from "./routers/integrations/asana.router";
...
import { innovationHubWorkflowRouter } from "./routers/project/innovation-hub-workflow.router";
...
import { cosTasksRouter } from "./routers/domains/cos-tasks.router";
import { workflowsRouter } from "./routers/domains/workflows.router";
