...
export const cosTrainingProgress = mysqlTable("cos_training_progress", {
  ...
  // Learning milestones
  communicationStyleLearned: boolean("communication_style_learned").default(
    false
  ),
  ...
  // Training level
  trainingLevel: mysqlEnum("training_level", [
    "novice",
    "learning",
    "proficient",
    "expert",
...
export const cosUserPreferences = mysqlTable("cos_user_preferences", {
  ...
  preferredLength: mysqlEnum("preferred_length", [
    "brief",
    "moderate",
    "detailed",
  ]).default("moderate"),
  preferredFormat: mysqlEnum("preferred_format", [
    "bullet_points",
    "paragraphs",
    "mixed",
  ]).default("mixed"),
  ...
  decisionSpeed: mysqlEnum("decision_speed", [
    "deliberate",
    "balanced",
    "quick",
  ]).default("balanced"),
  delegationStyle: mysqlEnum("delegation_style", [
    "hands_on",
    "balanced",
    "hands_off",
  ]).default("balanced"),
  ...
  // Content preferences
  reportDetailLevel: mysqlEnum("report_detail_level", [
    "executive_summary",
    "standard",
    "comprehensive",
  ]).default("standard"),
  dataVisualizationPreference: mysqlEnum("data_viz_preference", [
    "minimal",
    "moderate",
    "rich",
  ]).default("moderate"),
...
export const cosLessonsLearned = mysqlTable("cos_lessons_learned", {
  ...
  // Source interaction
  sourceInteractionId: int("source_interaction_id").references(
    () => cosInteractionLog.id
  ),
