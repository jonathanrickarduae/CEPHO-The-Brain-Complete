        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              description: "Receive prompts to log your mood 3x daily",
              enabled: true,
            },
            {
            ...
            {
              label: "AI Insights",
              description: "Receive insights from your Chief of Staff",
              enabled: false,
            },
            {
            ...
            },
            {
              ...
              description: "Get notified of security events in The Vault",
              enabled: true,
            },
            {
              label: "Integration Status",
              description: "Alerts when connected services have issues",
              enabled: true,
            },
          ].map((item, index) => (
            <div
