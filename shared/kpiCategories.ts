...
export const KPI_CATEGORIES: KpiCategory[] = [
  // STRATEGY DOMAIN (1-6)
  {
    ...
    domain: "strategy",
    description:
      "Clarity and communication of company vision, mission, and strategic direction",
    assessedBy: [
      "chief_of_staff",
      "strategic_advisory",
      "customer_focus_group",
    ...
    scoringCriteria: {
      excellent:
        "Vision is compelling, widely understood, and drives all decisions",
  ...
  },
  {
    ...
    scoringCriteria: {
      excellent:
        "Clear market leadership position with defensible differentiation",
  ...
  },
  {
    ...
    domain: "strategy",
    description:
      "Preparation for IPO, acquisition, or strategic sale within 24 months",
    assessedBy: [
      "chief_of_staff",
      "strategic_advisory",
      "finance_panel",
  ...
  // TECHNOLOGY DOMAIN (7-14)
  {
    ...
    domain: "technology",
    description:
      "Technical architecture quality, scalability, and maintainability",
  ...
  },
  {
    ...
    domain: "technology",
    description:
      "API quality, third party integrations, and ecosystem connectivity",
    assessedBy: ["chief_of_staff", "technology_panel"],
    scoringCriteria: {
  ...
  },
  {
    ...
    domain: "technology",
    description:
      "Quality of technical documentation, API docs, and knowledge base",
    assessedBy: ["chief_of_staff", "technology_panel"],
    scoringCriteria: {
  ...
  },
  {
    ...
    domain: "product",
    description:
      "Completeness of core features relative to market expectations",
    assessedBy: ["chief_of_staff", "technology_panel", "customer_focus_group"],
    scoringCriteria: {
...
export const KPI_DOMAINS: {
  ...
  { domain: "strategy", name: "Strategy", categoryIds: [1, 2, 3, 4, 5, 6] },
  {
    domain: "technology",
    name: "Technology",
    categoryIds: [7, 8, 9, 10, 11, 12, 13, 14],
  },
  {
    domain: "product",
    name: "Product",
    categoryIds: [15, 16, 17, 18, 19, 20, 21, 22],
  },
  {
    domain: "customer",
    name: "Customer",
    categoryIds: [23, 24, 25, 26, 27, 28, 29, 30],
  },
  {
    domain: "operations",
    name: "Operations",
    categoryIds: [31, 32, 33, 34, 35, 36],
  },
